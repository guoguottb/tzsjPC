		...
		<div class="info2">
			<el-form :model="dibaoForm" :rules="rules" :inline-message="true" :show-message="false" ref="dibaoForm"
				...
				<el-row :gutter="20">
					...
					<el-col :span="12">
						<el-form-item label="行政区域" prop="ab_ex162" v-if="isFinish">
							<el-cascader :props="props" v-model="xzqhArray"></el-cascader>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row :gutter="20">
	...
	export default {
		...
		methods: {
			...
			save() {
				...
				this.$set(this.dibaoForm,'ab_ex13','残联救助')
				// 设置定时器，30秒请求失败刷新页面
				let time = setTimeout(()=>{
								loading.close()
								this.$emit("closes", false)
