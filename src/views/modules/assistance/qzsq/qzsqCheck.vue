	...
	<div class="g-box2">
		<div class="info2">
			<el-form :model="dibaoForm" :rules="rules"  :inline-message="true" :show-message="false" ref="dibaoForm" label-width="auto" style='padding-right: 10px;' @submit.native.prevent>
				...
				<h3 class="line_blue" id="page5">&emsp;家庭前12个月收入情况<span style="color:red">*</span></h3>
				<div class="lineSt"></div>
				<div >
					<el-row class="button-group">
				...
				<div>
					...
					<el-table :data="income3" border :row-class-name="rowClassName" @selection-change="handleIncome3" rules empty-text='空' class="my-table">
						<el-table-column label="财产性收入(年)" align="center" required>
							<el-table-column type="selection" min-width="40" align="center" />
							<el-table-column label="计入收入名称" prop="abi_ex1" min-width="145"  >
								<!-- <template slot-scope="scope">
				...
				<el-row :gutter="20">
					<el-col :span="12" >
						<el-form-item label="医疗支出" prop="abp_ex4" label-width="220px" >
							<el-input v-model="pay.abp_ex4" placeholder="请输入医疗支出" @change="changeAmt3(pay.abp_ex4,'pay.abp_ex4')"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="教育支出" prop="abp_ex5" label-width="220px" >
				...
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="残疾康复费用支出" prop="abp_ex6" label-width="220px" >
							<el-input v-model="pay.abp_ex6" placeholder="请输入残疾康复费用支出" @change="changeAmt3(pay.abp_ex6,'pay.abp_ex6')"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="因灾、因意外事故费用支出" prop="abp_ex11" label-width="220px" >
				...
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="其他支出" prop="abp_ex7"  label-width="220px"  >
							<el-input v-model="pay.abp_ex7" placeholder="请输入其他支出" @change="changeAmt3(pay.abp_ex7,'pay.abp_ex7')"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="家庭总支出" prop="abp_ex8" label-width="220px" >
				...
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="扣减刚性支出后家庭年收入" prop="abp_ex9" label-width="220px"  >
							<el-input v-model="pay.abp_ex9" placeholder="请输入扣减刚性支出后家庭年收入" disabled>
							</el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="扣减刚性支出后人均年收入" prop="abp_ex10" label-width="220px"  >
							<el-input v-model="pay.abp_ex10" placeholder="扣减刚性支出后人均年收入" disabled ></el-input>
						</el-form-item>
					</el-col>
				</el-row>
			...
			<div class="mengBan" v-if="jisuanShow"><!-- 灰色蒙版 -->
				<el-card class="box-card calculations">
					<div slot="header" class="clearfix">
						<span style="font-size:18px;">政策计算器（<span>注：在本页面上填报修改的数据不会影响真实数据</span>）</span>
						<el-button style="float: right; padding: 3px 0" type="text" @click="closeCalculations">关闭</el-button>
					</div>

					<el-form :label-position="labelPosition" :model="jisuan" style="padding:0 20px">
						
						<el-row :gutter="20">
							<el-col :span="12" class="my-col">
								<el-form-item  label="家庭人员总数"  label-width="170px" >
									<el-input v-model="jisuan.familyNum" @change="changePerson" placeholder="请输入家庭人员总数"  type="number"></el-input>
								</el-form-item>
								
								<el-form-item  label="家庭中未成年人数" label-width="170px">
									<el-input style="display:inline-block;" v-model="jisuan.familyChildrens" type="number" @change="changePerson" placeholder="请输入家庭中未成年的人数"></el-input>
								</el-form-item>

								<el-form-item  label="法定赡抚养人数（非共同）" label-width="200px">
									<el-input style="display:inline-block;" v-model="jisuan.familyFD"  type="number" @change="changePerson" placeholder="请输入家庭中法定赡抚养人的人数" ></el-input>
								</el-form-item>

								<el-form-item  label="家庭年总刚性支出"  label-width="170px">
									<el-input style="display:inline-block;" v-model="jisuan.familyZzc" @change="changePerson" placeholder="请输入家庭年总刚性支出" ></el-input>
								</el-form-item>
							...
							<el-col :span="12" class="my-col">
								<el-form-item  label="家庭中老年人数" label-width="170px">
									<el-input style="display:inline-block;" v-model="jisuan.familyOlds" type="number" @change="changePerson" placeholder="请输入家庭中老年人的人数"></el-input>
								</el-form-item>

								<el-form-item  label="家庭中重残人数"  label-width="170px">
									<el-input style="display:inline-block;" v-model="jisuan.familyZC" type="number" @change="changePerson" placeholder="请输入家庭中重残人数" ></el-input>
								</el-form-item>

								<el-form-item  label="家庭中重病人数"  label-width="170px">
									<el-input style="display:inline-block;" v-model="jisuan.familyZB" type="number" @change="changePerson" placeholder="请输入家庭中重病人数" ></el-input>
								</el-form-item>
								
								<el-form-item  label="家庭总年收入"  label-width="170px">
									<el-input style="display:inline-block;" v-model="jisuan.familyAmt" @change="changePerson" placeholder="请输入家庭总年收入" ></el-input>
								</el-form-item>
					...
					<div style="text-align: center; margin:10px auto">
						<el-button type="primary" size="small"  @click="getJzData('1')">获取申请数据进行计算</el-button>
						<el-button type="success" size="small" @click="changeJS('2')">使用填报条件进行计算</el-button>
						...
						<el-button type="info" size="small" @click="clearJS">重置条件</el-button>
					...
					<div style="width:99%;margin:10px auto 0px;padding:10px;background-color:#f1f1f1;">
						<span  v-show ="jsjgshow1" style="font-size:18px;color:red;margin:10px 0;">您可能符合如下救助<span  style="font-size:14px;color:#111;margin: 0 5px;">（点击按钮查看救助金明细）</span></span>
						<span v-show ="jsjgshow2" style="font-size:18px;color:red;margin:10px 0;">您不符合救助条件</span>
						<p v-show ="jsjgshow1" class="jsjg" style="margin-bottom:10px;text-align: center;">
						<!-- <p v-show ="jsjgshow1" class="jsjg" style="margin-bottom:10px"> -->
							<!-- {{jsjgString}} -->
							
							<el-button type="primary" size="small" v-for="(item,index) in this.jsjg" :key="index" @click="showMoney(item)" >{{item}}</el-button>
						</p>
						<!-- <hr> -->
						 <el-table :data="moneyData" height="240" v-if="showTable" border style="width: 100% ;max-height:240px;overflow:auto">
							<el-table-column prop="name" label="成员" width="120"></el-table-column>
							<el-table-column  prop="type" label="选择的类型" width="150"></el-table-column>
							<el-table-column  prop="health" label="健康状况" width="150"></el-table-column>
							<el-table-column v-if="this.getHelpType.indexOf('最低生活保障-按户保')!=-1" prop="addObj"  label="是否为增发对象" width="150">
								<template slot-scope="scope">
									<el-select v-model="scope.row.addObj"  @change="add(scope.row.addObj,scope.row)">
										<!-- <el-option label="重病" value="重病"></el-option> -->
										<!-- <el-option label="残疾" value="残疾"></el-option> -->
										<!-- <el-option label="请选择"  value=""></el-option> -->
										<el-option label="否" value="否"></el-option>
							...
							<el-table-column  prop="lifeCost" v-if="this.getHelpType=='特困人员供养'" label="生活费" width="150"></el-table-column>
							<el-table-column  prop="careCost" v-if="this.getHelpType=='特困人员供养'" label="护理费" width="150"></el-table-column>
							<el-table-column  prop="money" label="成员保障金" width="150"></el-table-column>
						...
						<div v-if="showTable && !['低保-重病单列户','低保-重残单列户'].includes(moneyData[0].type)">
							<p v-for="(item,index ) in form3" :key="index" style="text-align: center;margin-top:10px"> <span style="color:green;width:200px;">{{item.name}} </span> 家庭月保障金合计为 {{item.money}} </p>
						</div>
						<div v-else-if="showTable && ['低保-重病单列户','低保-重残单列户'].includes(moneyData[0].type)">
							<el-row>
								<el-col :span="8" class="my-col"  v-for="(item,index ) in form3" :key="index">
								
										<p style="text-align: center;margin-top:10px"> <span style="color:green;width:200px;">{{item.name}} </span> 保障金合计为 {{item.money}} </p>
								</el-col>
							</el-row>
						</div>
	...
	export default {
		...
		data() {
			return {
				...
				isTrueData:true,		//是否为当前用户的真实数据 true 是 false否
				ab_ex40:0,
				form3:[{      //按人保成员保障金计算结果
					name:'',
					helpMoney:''
		...
		methods: {
			...
			changePerson(data,key){	
				if(this.jisuan.familyNum < this.jisuan.familyZC*1 + this.jisuan.familyZB*1){
					this.$message.error('重病重残的人数不能多于家庭人口');
					return false;
				}else if(this.jisuan.familyNum < this.jisuan.familyChildrens*1 + this.jisuan.familyOlds*1){
					this.$message.error('老年人、未成年人的人数不能多于家庭人口');
					return false;
				}
			...
			add(addType,data){
				...
				var averageMoney = this.jisuan.familyAmt != 0 ? this.jisuan.familyAmt / 12 / this.jisuan.familyNum : 0;

				if(addType!='否' ){

					if(data.health=='重病'){
						data.money = (this.dbStandard * 1.2).toFixed(0) ;
					}else if(data.health=='残疾'){

						if(averageMoney < 0.1*this.dbStandard){
							data.money = (this.dbStandard * 1.1 - averageMoney).toFixed(0);
						}else{
							data.money = (this.dbStandard * 1 ).toFixed(0);
						}
					...
					if(data.health=='重病'){
						...
						data.money = (this.dbStandard * 1 - averageMoney).toFixed(0);
					}
				}
				...
				for(let i in this.moneyData){
					this.ab_ex40 += this.moneyData[i].money*1;
				}
				console.log(this.moneyData,'资金表');
			},
			// 计算救助金额
			showMoney(type,data){
				...
				*/ 
				console.log(type,'类型');
				this.getHelpType = type;
				type = type == '特困人员供养' ? '特困供养' :type;
				type = type == '临时救助家庭' ? '临时救助' :type;
				type = type == '支出型困难家庭' ? '支出困难' :type;
				type = type == '单人保家庭' ? '单人保' :type;
				type = type == '低保边缘家庭' ? '低保边缘' :type;
				type = type == '最低生活保障-按户保' ? '低保-按户保' :type;
				type = type == '最低生活保障-按人保-重病单人保' ? '低保-重病单列户' :type;
				type = type == '最低生活保障-按人保-重残单人保' ? '低保-重残单列户' :type;
				...
				// 是否为真实数据
				// if(this.jisuan.familyNum != this.familyData1.length){
				...
				if(this.isTrueData){
					for(let i in this.familyData1){
						...
						// 成员
						this.moneyData[i].name = this.familyData1[i].abm_ex3;

						// 救助类型
						this.moneyData[i].type = type;
	
						// 健康状况
						// if(['二级','二级残疾','一级','一级残疾'].includes(this.familyData1[i].abm_ex11)){

						// 	this.moneyData[i].health = '重残';

						// }
						// if(this.jisuan.familyZB>0 && this.jisuan.familyZB>i){
	
						// 	this.moneyData[i].health = '重病';
	
						// }else{
						// 	this.moneyData[i].health = '健康';
						// }

						if(type=='特困供养'){
							console.log(this.jisuan.careCost,'护理费');
							console.log(this.jisuan.lifeCost,'生活费');
							this.moneyData[i].careCost = this.jisuan.careCost;
							this.moneyData[i].lifeCost = this.jisuan.lifeCost;
							this.moneyData[i].money = this.moneyData[i].careCost*1 + this.moneyData[i].lifeCost*1;
							...
							this.moneyData[i].careCost = 0;
							this.moneyData[i].lifeCost = 0;
						}
						
						
						if(type=='低保-按户保'){
							console.log('低保-按户保-标识',this.moneyData[i].health);

							// 是否增发对象
							if(this.familyData1[i].abm_ex11=='重病') {
								console.log(this.moneyData[i].health,'健康状况');

								this.moneyData[i].addObj = '否';
								this.moneyData[i].health = '重病1';

								if(['老年人','未成年人','独居','退役军人','归侨'].includes(this.familyData1[i].abm_ex51)){
									this.moneyData[i].addObj = this.familyData1[i].abm_ex51;
								}

								this.moneyData[i].money = (this.dbStandard * 1.2).toFixed(0);

							}else if(this.familyData1[i].abm_ex11=='残疾'){

								// 是否为重残
								if(['二级','二级残疾','一级','一级残疾'].includes(this.familyData1[i].abm_ex40)){
									this.moneyData[i].health = '重残1';
									this.moneyData[i].addObj = '否';
									...
									if(['老年人','未成年人','独居','退役军人','归侨'].includes(this.familyData1[i].abm_ex51)){
										...
										if(averageMoney < 0.1*this.dbStandard){
											...
											this.moneyData[i].money = (this.dbStandard * 1.1 - averageMoney).toFixed(0);

										}else{
											this.moneyData[i].money = (this.dbStandard * 1).toFixed(0)
										}
									}else{
										this.moneyData[i].money = (this.dbStandard * 1).toFixed(0)
									}
									...
									if(['老年人','未成年人','独居','退役军人','归侨'].includes(this.familyData1[i].abm_ex51)){
										...
										this.moneyData[i].addObj = '否';
										this.moneyData[i].money = (this.dbStandard * 1- averageMoney).toFixed(0);
									}
									
								}

							}else if(this.familyData1[i].abm_ex11=='健康' ){
						...
						}else if(type=='低保-重病单列户'){
							if(['重病'].includes(this.familyData1[i].abm_ex11)){
								this.moneyData[i].health = '重病';
								this.moneyData[i].money = this.dbStandard * 1;
							}
							
						}else if(type=='低保-重残单列户'){
							// var arrPorson=[];
							if(this.familyData1[i].abm_ex11=='残疾'){
								if(['二级','二级残疾','一级','一级残疾'].includes(this.familyData1[i].abm_ex40)){
									this.moneyData[i].health = '重残';
									this.moneyData[i].money = (this.dbStandard * 0.65).toFixed(0);

								}else if(['精神','精神残疾','智力','智力残疾'].includes(this.familyData1[i].abm_ex39) && this.familyData1[i].abm_ex40.indexOf('三级')!=-1){
									this.moneyData[i].health = '重残';
									this.moneyData[i].money = (this.dbStandard * 0.75).toFixed(0);

								}
							}else{
								this.moneyData[i].health = '健康';
								this.moneyData[i].money = 0;
							}

							console.log(this.moneyData[i] , i+'moneyData');
							...
							// this.moneyData[i].money = this.dbStandard - averageMoney;
							this.moneyData[i].money = '计算暂未完善';
					...
					// if(['低保-重病单列户','低保-重残单列户'].includes(type)){
					// 	this.moneyData = 
					// }
					console.log(this.moneyData,'this.moneyData');
				}else{
					this.moneyData=[];
					for(let i = 0 ; i < this.jisuan.familyNum; i++){
					// for(let i in 2){
						this.moneyData.push({
							name:'',
							type:'',
						...
						}else if(this.jisuan.familyZC > 0 && this.jisuan.familyZC>(i - this.jisuan.familyZB)){
						...
						// 是否增发对象
						console.log(this.jisuan.familyChildrens * 1,'未成年人人数');
						console.log(this.jisuan.familyOlds * 1 ,'老年人人数');

						if(this.jisuan.familyChildrens*1 + this.jisuan.familyOlds*1==0){
							this.moneyData[i].addObj = '否';

						}else if(this.jisuan.familyChildrens * 1 > i) {

							this.moneyData[i].addObj = '未成年人';

						}else if(this.jisuan.familyOlds * 1 > i - this.jisuan.familyChildrens) {

							this.moneyData[i].addObj = '老年人';
						}else{
							this.moneyData[i].addObj = '否';
						}
					...
					// 救助金额
					for(let j in this.moneyData){
						
						if(type=='特困供养'){
	
							this.moneyData[j].careCost = this.jisuan.careCost;
							this.moneyData[j].lifeCost = this.jisuan.lifeCost;
							this.moneyData[j].money = (this.moneyData[j].careCost*1 + this.moneyData[j].lifeCost*1).toFixed(0);

						}else{
							this.moneyData[j].careCost = 0;
							this.moneyData[j].lifeCost = 0;
						}
						
						if(type=='低保-按户保'){
							
							console.log('低保-按户保-按条件计算标识',this.moneyData[j].health);

							// 是否增发对象
							if(this.moneyData[j].health == '重病') {

								console.log(this.moneyData[j].health,'健康状况');
								this.moneyData[j].money = (this.dbStandard * 1.2).toFixed(0);

							}else if( this.moneyData[j].health == '重残'){

									if(['老年人','未成年人','独居','退役军人','归侨'].includes(this.moneyData[j].addObj)){
										// 就高原则
										if(averageMoney < 0.1*this.dbStandard){

											this.moneyData[j].money = (this.dbStandard * 1.1 - averageMoney).toFixed(0);

										}else{
											this.moneyData[j].money = (this.dbStandard * 1).toFixed(0)
										}
							...
							}else if(['健康'].includes(this.moneyData[j].health) ){
								...
								if(['老年人','未成年人','独居','退役军人','归侨'].includes(this.moneyData[j].addObj)){
									...
									this.moneyData[j].money = (this.dbStandard * 1 - averageMoney).toFixed(0);
								}
							}

						}else if(type=='临时救助'){
							
							this.moneyData[j].money = '暂无计算公式';
	
						}else if(type=='支出困难'){
							
							this.moneyData[j].money = 0;
						...
						}else if(type=='低保-重病单列户' && this.jisuan.familyZB>j){

							this.moneyData[j].money = this.dbStandard*1;
	
						}else if(type=='低保-重残单列户' && this.jisuan.familyZC>(j - this.jisuan.familyZB)){
							
							this.moneyData[j].money = (this.dbStandard * 0.65).toFixed(0);
						}
					}
				}
				...
				if(type=='低保-重病单列户'){
					...
					this.moneyData = this.moneyData.filter(item=> {return (item.health=='重病')})
				}

				if(type=='低保-重残单列户'){

					this.moneyData = this.moneyData.filter(item=> {return (item.health=='重残')})
				}
				


				if(['低保-按户保','特困供养','支出困难','单人保','低保边缘'].includes(type)){
					this.form3=[];
					this.ab_ex40 = 0;
					for(let j in this.moneyData){
						
						this.ab_ex40 += this.moneyData[j].money*1
					}
					this.form3.push({});

					// if(type=='临时救助'){

					// 	this.form3[0].money = '该计算暂未完善';
					// }else{

						this.form3[0].money = this.ab_ex40;
					// }

					if(this.isTrueData){

						this.form3[0].name = this.dibaoForm.ab_ex3;
						
					}else{

						this.form3[0].name = this.moneyData[0].name;
					}

				}else if(['临时救助'].includes(type)){
					// 临时救助的金额还没想好怎么算
					this.form3[0].money = 0;
					console.log('临时救助金额',this.form3[0].money);
				}else 
				{	//单列户
					this.form3=[];
					for(let i in this.moneyData){
						this.form3.push({});
						this.form3[i].name = this.moneyData[i].name;
						this.form3[i].money = this.moneyData[i].money;

					}

				}

				console.log(this.form3,'保障金');
				console.log(this.moneyData,'明细');
			},
			...
			closeCalculations(){
				...
				this.jisuan.familyOlds='';
				this.jisuan.lifeCost='';
				this.jisuan.careCost='';
			...
			clearJS(){
				...
				this.jisuan.careCost='0.00';
				this.jisuan.familyChildrens='0';
				this.jisuan.familyOlds='0';
			...
			keyVerification(key,id){
				...
				if(id=="aba_ex3" && key!=""){
					...
					this.agentInfo.aba_ex3=key.replace(/x$/i,"X");
					msg=isCardID(key,id)
					if(msg!=true){
						console.log(msg);
			...
			async loadData() {// 进入页面加载数据
				...
				this.getBasic({
					...
					// cun 村名操作以‘村’结尾加上委会，以‘区’结尾后缀加上‘居委会’，泰兴市除外因为泰兴的村没有委会的
					if(this.xzqhArray[2]){
			...
			changeAmt(index,row,id) {
				...
				if(this.familyData1.length>0){
					for(let j=0;j<this.familyData1.length;j++){
						if(this.familyData1[j].abm_ex11=="残疾" ){
							if(['一级','一级残疾','二级','二级残疾'].includes(this.familyData1[j].abm_ex40)){
								...
								// 特困残疾计数
								disabilityTK++;
								this.familyData1[j].abm_ex49 = '无劳动能力';
							}
					...
					this.jisuan.familyOlds = old;  //老年人
			...
			console.log( this.isSaves,' this.isSaves');
