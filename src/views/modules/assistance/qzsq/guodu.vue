					...
					<div style="width:99%;margin:10px auto 0px;padding:10px;background-color:#f1f1f1;">
						...
						<!-- <hr> -->
						 <el-table :data="moneyData" height="240" v-if="showTable" border style="width: 100% ;max-height:240px;overflow:auto">
							...
							<el-table-column v-if="this.jsjgString.indexOf('最低生活保障-按户保')!=-1" prop="addObj"  label="是否为增发对象" width="150">
								<template slot-scope="scope">
							...
							<el-table-column  prop="lifeCost" v-if="this.jsjg[0]=='特困人员供养'" label="生活费" width="150"></el-table-column>
							<el-table-column  prop="careCost" v-if="this.jsjg[0]=='特困人员供养'" label="护理费" width="150"></el-table-column>
		...
		methods: {
			...
			showMoney(type,data){
				...
				*/ 
				...
				if(['低保-按户保','特困供养','临时救助','支出困难','单人保','低保边缘'].includes(type)){
					this.form3=[];
					this.ab_ex40 = 0;
					for(let j in this.moneyData){
