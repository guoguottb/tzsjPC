	...
	<div class="g-box2">
		<div class="info2">
			<el-form :model="dibaoForm" :rules="rules" :inline-message="true" :show-message="false" ref="dibaoForm"
				...
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="年度" prop="ab_ex42">
							<el-date-picker value-format="yyyy" v-model="dibaoForm.ab_ex42" type="year" placeholder="请选择年度"></el-date-picker>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="学期" prop="ab_ex43">
							<el-select v-model="dibaoForm.ab_ex43" placeholder="请选择学期">
		...
		methods: {
			...
			loadData() {
				...
				this.getBasic({
					...
					console.log(res.response.data[0].common.length)//新增数据长度为0，修改为1
			...
			save() {
				...
				this.$set(this.dibaoForm,'ab_ex13','教育救助')
