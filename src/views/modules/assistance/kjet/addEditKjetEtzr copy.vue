			...
			<div class="info2">
				<el-form :model="dibaoForm" :rules="rules"  :inline-message="true" :show-message="false" ref="dibaoForm" label-width="auto" style='padding-right: 10px;'>
					...
					<!-- <div style="display:flex;"> -->
						...
						<!-- </div> -->
						<!-- <div style=" display: inline-block;width:20%; border:dashed 1px #999;text-align:center;position: relative;">
							<el-avatar icon="el-icon-user-solid" style="width:100px ;height:100px; display: inline-block;font-size:50px;margin:20px auto"></el-avatar>
							<div style="position: absolute;top: 80px;color: #907752;left: 78px; font-size:20px">头像</div>
						</div> -->
					<!-- </div> -->
					...
					<el-row :gutter="20">
						...
						<el-col :span="12" v-if="dibaoForm.abcd_ex28=='儿童主任'">
					...
					<el-row :gutter="20">
						<el-col :span="24">
							<el-form-item label="工作及培训经历" prop="abcd_ex26">
								<el-input v-model="dibaoForm.abcd_ex26" type="textarea" :autosize="{ minRows: 3}" placeholder="请输入工作及培训经历"></el-input>
							</el-form-item>
						</el-col>
					</el-row>
...
<style scoped>
	...
	.head_photo{
		...
		width: 120px;
		height: 140px;
		/* background-color: rgb(177, 174, 137); */
