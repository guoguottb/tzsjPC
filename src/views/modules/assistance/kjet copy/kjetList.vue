  ...
  <div class="g-box">
      ...
      <el-form :inline="true" :model="searchData" class="demo-form-inline" >
        ...
        <el-form-item label-width="110px" label="是否重病" >
          <el-select v-model="searchData.whetherSeriousIllness" placeholder="请选择是否重病">
            <el-option v-for="item in whethers" :key="item.value" :label="item.label" :value="item.value">
            </el-option>
          </el-select>
        </el-form-item>
        <el-form-item label-width="110px" label="残疾类型" >
          <el-select v-model="searchData.disabilityType" placeholder="请选择残疾类型">
            <el-option v-for="item in disabilityTypes" :key="item.value" :label="item.label" :value="item.value">
            </el-option>
          </el-select>
        </el-form-item>
        <!-- <el-form-item label-width="110px" label="残疾类型" >
    ...
    <div class="content">
      <el-tabs v-model="activeName" @tab-click="handleClickSelect">
        <el-tab-pane  v-for="(item, index) in options2" :key="index" :name="item.listname" :label="item.listname" >
      ...
      <el-table  ref="multipleTable" :data="tableData" tooltip-effect="dark" border
		...
		<el-table-column v-if="isReturn" prop="backTime" label="退回时间" width="100px"></el-table-column>
		<el-table-column v-if="isCheckDispatch" prop="dispatchTime" label="核查派单时间" width="150px"></el-table-column>
		<el-table-column v-if="isInformationCheck" prop="checkTime" label="信息核对时间" width="150px"></el-table-column>
        ...
        <el-table-column prop="active"  label="操作" :width="cazuoBtn">
          <template slot-scope="scope">
            <el-button-group>
              ...
              <!-- 申请节点的按钮 -->
              <el-button  v-if="isApplication" @click="handleClick(scope.row ,'修改')"    type="primary" size="small">修改</el-button>
              <el-button  v-if="isApplication" @click="handleClick(scope.row ,'核查派单')" type="danger" size="small">核查派单</el-button>
              <!-- 退回节点的按钮 -->
              <el-button  v-if="isReturn" @click="handleClick(scope.row ,'退回重新核查')" type="danger" size="small">退回重新核查</el-button>
              <el-button  v-if="isReturn" @click="handleClick(scope.row ,'救助申请不予批准决定书')" type="danger" size="small">救助申请不予批准决定书</el-button>
              <!-- 核查派单节点的按钮 -->
              <el-button  v-if="isCheckDispatch" @click="handleClick(scope.row ,'上门核查')" type="primary" size="small">上门核查</el-button>
              <el-button  v-if="isCheckDispatch" @click="handleClick(scope.row ,'提交信息核对')" type="danger" size="small">提交信息核对</el-button>
              <el-button  v-if="isCheckDispatch" @click="handleClick(scope.row ,'退回')" type="primary" size="small">退回</el-button>
              <!-- 信息核对节点的按钮 -->
              <el-button  v-if="isInformationCheck" @click="handleClick(scope.row ,'查看核对报告')" type="primary" size="small">查看核对报告</el-button>
              <el-button  v-if="isInformationCheck" @click="handleClick(scope.row ,'提交审核')" type="danger" size="small">提交审核</el-button>
              <el-button  v-if="isInformationCheck" @click="handleClick(scope.row ,'退回重新核查')" type="primary" size="small">退回重新核查</el-button>
              <el-button  v-if="isInformationCheck" @click="handleClick(scope.row ,'退回')" type="primary" size="small">退回</el-button>
            </el-button-group>
          </template>
        </el-table-column>
      </el-table>
