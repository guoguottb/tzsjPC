<template>
	...
	<div class="g-box">
		<div class="g-box2">
			<div class="info2">
				<el-form  v-if="isOk"  ref="Form" label-width="auto" style='padding-right: 10px;' @submit.native.prevent>
					<h3 class="line_blue" id="page1">&emsp;儿童基本情况</h3>
					<div class="lineSt"></div>
					<el-row :gutter="20">
						<el-col :span="12">
							<el-form-item label="收养状态" prop="basicInfo.adoptedType">
								<el-select v-model="dibaoForm.basicInfo.adoptedType" placeholder="请选择收养状态"  style="width:100%">
						...
						<el-col :span="12">
							<el-form-item label="是否患有艾滋病" prop="basicInfo.sufferFromAids">
								<el-select  v-model="dibaoForm.basicInfo.sufferFromAids" style="width:100%;">
					...
					<el-row :gutter="20">
					    ...
					    <el-col :span="12">
							<el-form-item label="身份证号" prop="basicInfo.idCard">
								<el-input   v-model="dibaoForm.basicInfo.idCard" placeholder="请输入身份证号"></el-input>
							</el-form-item>
					...
					<el-row :gutter="20">
						<el-col :span="12">
							<el-form-item label="性别" prop="basicInfo.gender">
								<el-input v-model='dibaoForm.basicInfo.gender' disabled style="width:100%;" >                        			
								</el-input>
							</el-form-item>						
						</el-col>
						<el-col :span="12">
							<el-form-item label="出生日期" prop="basicInfo.birth">
								<el-input v-model='dibaoForm.basicInfo.birth' disabled style="width:100%;" >                        			
								</el-input>
							</el-form-item>											
						</el-col>						
					</el-row>
					<el-row :gutter="20">
						<el-col :span="12">
							<el-form-item label="民族"  prop="basicInfo.nation">
						...
						<el-col :span="12">
							<el-form-item label="行政区域" prop="basicInfo.divisionCode">
								<el-cascader  :props="props" v-model="xzqhArray" placeholder="请选择" style="width:100%;" ></el-cascader>
							</el-form-item>
						</el-col>	
					</el-row>
					<el-row :gutter="20">
						<el-col :span="12">
							<el-form-item label="户籍类型" prop="basicInfo.censusRegisterType"  >
						...
						<el-col :span="12">
							<el-form-item label="户籍地址" prop="basicInfo.censusRegisterAddress" >
					...
					<el-row :gutter="20">
						<el-col :span="12">
							<el-form-item label="开户人" prop="basicInfo.bankAccountName">
								<el-input v-model="dibaoForm.basicInfo.bankAccountName" placeholder="请输入开户人"></el-input>
							</el-form-item>
						</el-col>
					    <el-col :span="12">
					    	<el-form-item label="开户行" prop="basicInfo.bankName">
					...
					<el-row :gutter="20">
						<el-col :span="12">
							<el-form-item label="开户卡号" prop="basicInfo.bankCardId">
								<el-input v-model="dibaoForm.basicInfo.bankCardId" placeholder="请输入开户卡号"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item label="居住地址" prop="basicInfo.residentialAddress">
					...
					<el-row :gutter="20">
						<el-col :span="12">
							<el-form-item label="行为能力" prop="basicInfo.haveFullCapacity">
								<el-select  v-model="dibaoForm.basicInfo.haveFullCapacity" style="width:100%;">
									<el-option label="完全行为能力" :value="true"></el-option>
									<el-option label="限制行为能力" :value="false"></el-option>
								</el-select>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item label="是否在校" prop="basicInfo.whetherInSchool" >
								<el-select  v-model="dibaoForm.basicInfo.whetherInSchool" style="width:100%;">
									<el-option label="是" :value="true"></el-option>
									<el-option label="否" :value="false"></el-option>
								</el-select>
							</el-form-item>
					...
					<el-row :gutter="20">
						<el-col :span="24">
							<el-form-item label="生活状况简述" prop="basicInfo.livingDesc">
								<el-input v-model="dibaoForm.basicInfo.livingDesc" placeholder="请输入儿童生活状况"></el-input>
							</el-form-item>
						</el-col>	
					</el-row>
					<el-row :gutter="20">						
					    <el-col :span="12">
					    	<el-form-item label="儿童主任姓名" prop="basicInfo.childrenDirectorName">
					    		<el-input v-model="dibaoForm.basicInfo.childrenDirectorName" placeholder="请输入儿童主任姓名"></el-input>
					    	</el-form-item>
					    </el-col>
						<el-col :span="12">
							<el-form-item label="儿童主任联系电话" prop="basicInfo.childrenDirectorTel">
					...
					<el-row :gutter="20">
						<!-- 身体状况 -->
						    <el-col :span="12">
								<el-form-item label="是否健康" prop="basicInfo.whetherHealth">
						    ...
						    <el-col :span="12">
						    	<el-form-item label="是否重病" prop="basicInfo.whetherSeriousIllness">
						...
						<el-row :gutter="20">
						<el-col :span="12">
							<el-form-item label="重病类型" prop="basicInfo.seriousIllnessType">
								<el-select v-model="dibaoForm.basicInfo.seriousIllnessType"  clearable style="width:100%;">
									...
									<el-option label="其他重病" value="其他重病"></el-option>
								</el-select>
							</el-form-item>
						</el-col>
					    <el-col :span="12">	
					    	<el-form-item label="是否残疾" prop="basicInfo.whetherDisability">
					...
					<el-row :gutter="20" >
					    <el-col :span="12">
					    	<el-form-item label="残疾类型" prop="basicInfo.disabilityType">
					    ...
					    <el-col :span="12">
					    	<el-form-item label="残疾等级" prop="basicInfo.disabilityLevel">
					...
					<el-row :gutter="20">
						<el-col :span="12">
							<el-form-item label="残疾救助方式" prop="basicInfo.disabilityRescueMode">
								<el-select v-model="dibaoForm.basicInfo.disabilityRescueMode" clearable style="width:100%;">
									<el-option label="无" value="无"></el-option>
									<el-option label="一户多残" value="一户多残"></el-option>
									<el-option label="依老养残" value="依老养残"></el-option>
								</el-select>
							</el-form-item>
						</el-col>
					    <el-col :span="12">
							<el-form-item label="其他残疾类型情况说明" prop="basicInfo.descriptionOfDisability">
					...
					<el-row :gutter="20">
						<el-col :span="12" >
							<el-form-item label="学校名称" prop="basicInfo.schoolName">
								<el-input v-model="dibaoForm.basicInfo.schoolName" placeholder="请输入学校名称"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item label="年级（班级）" prop="basicInfo.gradeClass">
					...
					<el-row :gutter="20">
						<el-col :span="12">
							<el-form-item label="教师妈妈" prop="basicInfo.teacher">
								<el-input v-model="dibaoForm.basicInfo.teacher" placeholder="请输入教师妈妈名称"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item label="教师妈妈联系电话" prop="basicInfo.teacherTel">
					...
					<el-row :gutter="20">
						<el-col :span="24">
							<el-form-item label="遭受侵害和虐待" prop="typeOfInfringed">
								<el-select v-model="typeOfInfringed" multiple style="width:100%">
									<el-option label="无" value="无"></el-option>
					...
					<el-row :gutter="20">
						<el-col :span="24">					
							<el-form-item label="失足未成年人" prop="typeOfJuvenileDelinquent">
								<el-select v-model="typeOfJuvenileDelinquent" multiple style="width:100%">
									<el-option label="无" value="无"></el-option>
					...
					<el-row :gutter="20">
						<el-col :span="24">
							<el-form-item label="遭遇困境类型" prop="typeOfEncounteringEmergencies">                    			
								<el-select v-model="typeOfEncounteringEmergencies" multiple style="width:100%">
									<el-option label="无" value="无"></el-option>
					...
					<el-row :gutter="20">
						<el-col :span="24">
							<el-form-item label="流浪儿童类型" prop="basicInfo.typeOfStreetChildren">
								<el-select v-model="dibaoForm.basicInfo.typeOfStreetChildren" clearable style="width:100%" >
									<el-option label="无" value="无"></el-option>
					...
					<el-row :gutter="20">
						<el-col :span="12">
							<el-form-item label="是否填写父母信息" prop="familyInfo.whetherNoParentInfo">
								<el-select v-model="dibaoForm.familyInfo.whetherNoParentInfo" @change="isShowParentInfo" style="width:100%;">
									<el-option label="是" :value="true"></el-option>
									<el-option label="否" :value="false"></el-option>
								</el-select>
							</el-form-item>
					...
					<el-row :gutter="20">
						<el-col :span="12">
							<el-form-item label="父亲姓名" prop="familyInfo.father.name">
								<el-input v-model="dibaoForm.familyInfo.father.name" placeholder="请输入父亲姓名"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item label="父亲身份证号码" prop="familyInfo.father.cardId">
					...
					<el-row :gutter="20">
						<el-col :span="12">
							<el-form-item label="父亲联系电话" prop="familyInfo.father.tel">
								<el-input v-model="dibaoForm.familyInfo.father.tel" type="number" placeholder="请输入父亲联系电话"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item label="父亲当前状况" prop="familyInfo.father.type">
								<el-select v-model="dibaoForm.familyInfo.father.type" placeholder="请选择父亲当前状况" style="width:100%" >
					...
					<el-row :gutter="20">
					    <el-col :span="12">
					    	<el-form-item label="父亲重病情况简述" prop="familyInfo.father.seriousIllnessDesc">
					...
					<el-row :gutter="20">
					    ...
					    <el-col :span="12">
					    	<el-form-item label="父亲不履行监护抚养责任报案时间" prop="fatherReportTime">
					    		<el-date-picker v-model="dibaoForm.familyInfo.father.reportTime" type="datetime"  value-format="yyyy-MM-dd HH:mm:ss"  placeholder="请选择父亲不履行监护抚养责任报案时间" style="width: 100% !important;"></el-date-picker>
					    	</el-form-item>
					    </el-col>
					</el-row>
					<el-row :gutter="20">
						<el-col :span="12">
							<el-form-item label="父亲服刑在押羁押时间" prop="fatherDetentionTime">
								<el-date-picker v-model="dibaoForm.familyInfo.father.detentionTime" type="datetime"  value-format="yyyy-MM-dd HH:mm:ss"  placeholder="请选择父亲服刑在押羁押时间" style="width: 100% !important;"></el-date-picker>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item label="父亲服刑在押羁押期限(月)" prop="fatherTermInCustody">
								<el-input v-model="dibaoForm.familyInfo.father.termInCustody" type='number' placeholder="请输入父亲服刑在押羁押期限(月)" ></el-input>
							</el-form-item>
						</el-col>
					</el-row>
					<el-row :gutter="20">
						<el-col :span="12">
							<el-form-item label="父亲强制戒毒隔离时间" prop="fatherIsolationTime">
								<el-date-picker v-model="dibaoForm.familyInfo.father.isolationTime" type="datetime"  value-format="yyyy-MM-dd HH:mm:ss"  placeholder="请选择父亲强制戒毒隔离时间" style="width: 100% !important;"></el-date-picker>
							</el-form-item>
						</el-col>
						<el-col :span="12">
					...
					<el-row :gutter="20">
						...
						<el-col :span="12">
							<el-form-item label="母亲当前状况" prop="motherType">
								<el-select v-model="dibaoForm.familyInfo.mother.type" placeholder="请选择母亲当前状况" style="width:100%">
									<el-option label="健康" value="健康"></el-option>
									<el-option label="重病" value="重病"></el-option>
									<el-option label="残疾" value="残疾"></el-option>
									<el-option label="自然死亡" value="自然死亡"></el-option>
					...
					<el-row :gutter="20">
					    ...
					    <el-col :span="12">
					    	<el-form-item label="母亲不履行监护抚养责任报案时间" prop="motherReportTime">  
					    		<el-date-picker v-model="dibaoForm.familyInfo.mother.reportTime" type="datetime"  value-format="yyyy-MM-dd HH:mm:ss"  placeholder="请选择母亲不履行监护抚养责任报案时间" style="width: 100% !important;"></el-date-picker>
					    	</el-form-item>
					    </el-col>
					</el-row>
					<el-row :gutter="20">
						<el-col :span="12">
							<el-form-item label="母亲服刑在押羁押时间" prop="motherDetentionTime">
								<el-date-picker v-model="dibaoForm.familyInfo.mother.detentionTime" type="datetime"  value-format="yyyy-MM-dd HH:mm:ss"  placeholder="请选择母亲服刑在押羁押时间" style="width: 100% !important;"></el-date-picker>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item label="母亲服刑在押羁押期限(月)" prop="motherTermInCustody">
								<el-input v-model="dibaoForm.familyInfo.mother.termInCustody" type='number' placeholder="请输入母亲服刑在押羁押期限(月)" ></el-input>
							</el-form-item>
						</el-col>
					</el-row>
					<el-row :gutter="20">
						<el-col :span="12">
							<el-form-item label="母亲强制戒毒隔离时间" prop="motherIsolationTime">
								<el-date-picker v-model="dibaoForm.familyInfo.mother.isolationTime" type="datetime"  value-format="yyyy-MM-dd HH:mm:ss"  placeholder="请选择母亲强制戒毒隔离时间" style="width: 100% !important;"></el-date-picker>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item label="母亲强制戒毒隔离期限(月)" prop="motherIsolationPeriod">
								<el-input v-model="dibaoForm.familyInfo.mother.isolationPeriod" type='number' placeholder="请输入母亲强制戒毒隔离期限(月)"></el-input>
							</el-form-item>
						</el-col>
					</el-row>
					<el-row :gutter="20">
					...
					<el-row :gutter="20">
						<el-col :span="12">
							<el-form-item label="是否贫困家庭" prop="familyInfo.whetherPoorFamilies">
						...
						<el-col :span="12" >
							<el-form-item label="贫困类型" prop="familyInfo.typesOfPoverty">
					...
					<el-row :gutter="20">
						<el-col :span="12">
							<el-form-item label="儿童微心愿" prop="familyInfo.childrenNeeds">
								<el-input v-model="dibaoForm.familyInfo.childrenNeeds" placeholder="请输入儿童微心愿"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item label="其他需求" prop="familyInfo.otherNeeds">
					...
					<el-row :gutter="20">
						<el-col :span="12">
							<el-form-item label="家庭主要诉求" prop="familyInfo.familyNeeds">
					...
					<el-row :gutter="20">
					    <el-col :span="12">
					        <el-form-item label="生活保障情况" prop="assureInfo.whetherGuarantee">
					    ...
					    <el-col :span="12">
					        <el-form-item label="保障方式" prop="assureInfo.guaranteeMode">
					...
					<el-row :gutter="20">
					    <el-col :span="24">
					        <el-form-item label="其他保障方式简述" prop="assureInfo.guaranteeModeResume">
					...
					<el-row :gutter="20">
					    <el-col :span="12">
					        <el-form-item label="发放金额" prop="assureInfo.paymentAmount">
					            <el-input v-model="dibaoForm.assureInfo.paymentAmount" placeholder="请填报发放金额"></el-input>
					        </el-form-item>
					    </el-col>
					    <el-col :span="12">
					        <el-form-item label="发放周期" prop="assureInfo.distributionCycle">
					...
					<el-row :gutter="20">
					    <el-col :span="12">
					        <el-form-item label="发放方式" prop="assureInfo.distributionMethod">
					    ...
					    <el-col :span="12">
					        <el-form-item label="收领人" prop="assureInfo.receiver">
					...
					<el-row :gutter="20">
					    <el-col :span="12">
					        <el-form-item label="与儿童关系" prop="assureInfo.withChildren">
					...
					<el-row :gutter="20">
					    <el-col :span="12">
					        <el-form-item label="是否有教育资助" prop="assureInfo.whetherEducationSubsidy">
					    ...
					    <el-col :span="12">
					        <el-form-item label="教育资助是否免学杂费" prop="assureInfo.whetherFreeOfSchoolFees">
					...
					<el-row :gutter="20">
						<el-col :span="12">
						    <el-form-item label="教育资助是否免书本费" prop="assureInfo.whetherFreeBooks">
					    ...
					    <el-col :span="12">
					        <el-form-item label="减保教费(元/年)" prop="dibaoForm.assureInfo.reduceTheAmountOfTuition">
					...
					<el-row  :gutter="20">
					    <el-col :span="12">
					        <el-form-item label="教育资助(元/年)" prop="assureInfo.educationSubsidOfMoney">
					            <el-input v-model="dibaoForm.assureInfo.educationSubsidOfMoney" type="number" placeholder="请填写教育资助"></el-input>
					        </el-form-item>
					    </el-col>
					    <el-col :span="12">
					...
					<h3 v-if="isSelect" class="line_blue" id="page23">&emsp;审批记录</h3>
					<div v-if="isSelect" class="lineSt"></div>
						<table v-if="isSelect" style="width:100%;table-layout:fixed" id="recordt">
							<colgroup>
								<col style="width:15%">
								<col style="width:20%">
								<col style="width:15%">
							...
							<tbody v-for="(itemR,index) in record" :key="index">
								...
								<tr>							
									...
									<td rowspan="2" style="text-align:left" >
										...
										<img v-else-if="itemR.result =='退回重新核查'" src="@/assets/img/auditStatus/return2.png"
											style="width:100px">
					...
					<!-- 当点击退回按钮出现本模块 -->
					<h3  v-if="isReturn" class="line_blue" id="page20">&emsp;退回意见</h3>
					<div v-if="isReturn" class="lineSt"></div>
					<div v-if="isReturn" id="recordt" style="margin-bottom:10px">
						<el-row :gutter="20">
							<el-col :span="12">
								<el-form-item label="处理结果">
									<el-select v-model="handlingCommentsList.result" style="width:100%">
										<el-option label="同意" value="同意"></el-option>
										<el-option label="退回重新核查" value="退回重新核查"></el-option>
							...
							<el-col :span="12">
								<el-form-item label="处理备注"> 						
									<el-input v-model="handlingCommentsList.remark" type="textarea" placeholder="请填写处理备注"></el-input>
								</el-form-item>
							</el-col>
						</el-row> 
						<el-row :gutter="20">
								...
								<el-form-item label="处理材料"> 		
									<el-card class="box-card">
										<div slot="header" class="clearfix">
											<el-button style="float: left; padding: 3px 0" type="text" @click="handleRemove(uploadImg,'material')">删除</el-button>
											<span>上传退回材料</span>
											<el-button style="float: right; padding: 3px 0" type="text" @click="uploads('material','handlingCommentsList')">上传</el-button>
										</div>
										<div class="block">
											<image-view :imgList="uploadImg.material_img"  @Imgindex='getImgIndex'></image-view>
										</div>
									</el-card>
								</el-form-item>	
							</el-col>
						...
						<el-row :gutter="20">
							<el-col :span="12">
								<el-form-item > 		
									<el-button type="danger" @click="subClick">确定退回</el-button>
								</el-form-item>
							</el-col>
						</el-row> 
					</div>	
					<!-- 提交到审批 -->
					<h3 v-if="isSubToApproval" class="line_blue" id="page21">&emsp;审核</h3>
					<div v-if="isSubToApproval" class="lineSt"></div>
					<div v-if="isSubToApproval" id="recordt" style="margin-bottom:10px">
						<el-row :gutter="20">
							<el-col :span="12">
								<el-form-item label="处理结果">
									<el-select v-model="handlingCommentsList.result" style="width:100%">
						...
						<el-row :gutter="20">
							<el-col :span="12">
								<el-form-item > 		
									<el-button type="danger" @click="subClick">提交</el-button>
								</el-form-item>
							</el-col>
						</el-row> 
					</div>
					<!-- 提交到办结 -->
					<h3 v-if="isSubToFinish" class="line_blue" id="page22">&emsp;审核</h3>
					<div v-if="isSubToFinish" class="lineSt"></div>
					<div v-if="isSubToFinish" id="recordt" style="margin-bottom:10px">
						<el-row :gutter="20">
							<el-col :span="12">
								<el-form-item label="处理结果">
									<el-select v-model="handlingCommentsList.result" style="width:100%">
			...
			<div class="ainfo2">
				...
				<div style="margin-left:20px;margin-top:20px;">
					<ul>
						...
						<li v-if="isReturn" :class="{listStyle:isShow20}" @click="isShow(20)">
							<a class="ainfoFont" :class="{listStyleA:!isShow20}" @click="counter('#page20')">退回意见</a><br>
						</li>
						<li v-if="isSubToApproval" :class="{listStyle:isShow21}" @click="isShow(21)">
							<a class="ainfoFont" :class="{listStyleA:!isShow21}" @click="counter('#page21')">提交审核意见</a><br>
						</li>
						<li v-if="isSubToFinish" :class="{listStyle:isShow22}" @click="isShow(22)">
							<a class="ainfoFont" :class="{listStyleA:!isShow22}" @click="counter('#page22')">提交审批意见</a><br>
						</li>
						<li v-if="isSelect" :class="{listStyle:isShow23}" @click="isShow(23)">
							<a class="ainfoFont" :class="{listStyleA:!isShow23}" @click="counter('#page23')">审批记录</a><br>
						</li>
					</ul>
				</div>
			</div>
...
<script>
	...
	export default {
		...
		created() {
			//this.loadData();
			//alert(this.$route.query.type=="退回")
			...
			this.getBasic({
			    ...
			    console.log(data)
				//this.dibaoForm = data
				this.dibaoForm.basicInfo  = data.basicInfo
				this.dibaoForm.assureInfo = data.assureInfo
				this.dibaoForm.familyInfo = data.familyInfo
				this.isNoParent=this.dibaoForm.familyInfo.whetherNoParentInfo
				this.isOk=true
