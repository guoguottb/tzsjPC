		...
		<div class="g-box2">
			<div class="info2">
				<el-form :model="dibaoForm"  :rules="rulesForm" v-if="isOk" :inline-message="true" :show-message="false" ref="dibaoForm" label-width="auto" style='padding-right: 10px;'>
					...
					<el-row :gutter="20">
						...
						<el-col :span="12">
							<el-form-item label="是否患有艾滋病" prop="basicInfo.sufferingFromAids">
								<el-select  v-model="dibaoForm.basicInfo.sufferingFromAids" style="width:100%;">
					...
					<el-row :gutter="20">
						...
						<el-col :span="12">
							<el-form-item label="父亲身份证号码" prop="familyInfo.father.cardId">
								<el-input v-model="dibaoForm.familyInfo.father.cardId" @change="changeCid" placeholder="请输入父亲身份证号码"></el-input>
							</el-form-item>
						</el-col>
					</el-row>
					<el-row :gutter="20">
                    ...
                    <el-row :gutter="20">
                    	...
                    	<el-col :span="12">
                    		<el-form-item label="母亲身份证号码" prop="motherCardId">
                    			<el-input v-model="dibaoForm.familyInfo.mother.cardId" @change="changeCid"  placeholder="请输入母亲身份证号码"></el-input>
                    		</el-form-item>
                    	</el-col>
                    </el-row>
                    <el-row :gutter="20">
					...
					<el-table :data="dibaoForm.familyInfo.guardians" border empty-text='空' class="my-table">
						...
						<el-table-column prop="guardiansActualGuardianCardId" label="身份证号码" min-width="190">
							<template slot-scope="scope">
								<el-input v-model="scope.row.actualGuardianCardId" @change="changeCid"></el-input>
							</template>
						</el-table-column>
                    ...
                    <el-row :gutter="20">
                        <el-col :span="12">
                            <el-form-item label="发放方式" prop="basicInfo.collectionMethod">
                                <el-select v-model="dibaoForm.basicInfo.collectionMethod" style="width:100%">
                        ...
                        <el-col :span="12">
                            <el-form-item label="收领人" prop="basicInfo.receiver">
                                <el-input v-model="dibaoForm.basicInfo.receiver" placeholder="请填写收领人"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
					<el-row :gutter="20">
					    <el-col :span="12">
					        <el-form-item label="收领人身份证" prop="basicInfo.receiverIdCard">
					            <el-input v-model="dibaoForm.basicInfo.receiverIdCard" @change="changeCid" placeholder="请填写收领人身份证"></el-input>
					        </el-form-item>
					    </el-col>
					    <el-col :span="12">
					        <el-form-item label="收领人电话" prop="basicInfo.receiverPhone">
					            <el-input v-model="dibaoForm.basicInfo.receiverPhone" placeholder="请填写收领人电话"></el-input>
					        </el-form-item>
					    </el-col>
					</el-row>
                    <el-row :gutter="20">
			...
			<div class="ainfo2">
				<div style="margin-left:20px;text-align:center;border-bottom:1px solid #ddd;padding-bottom:10px;">
					<el-button type="primary" size="small" @click="save('dibaoForm')">保存</el-button>
		...
		data() {
			return {
				...
				rulesForm: {				
					...
					'basicInfo.sufferingFromAids':[
						{ required: true, message: '请选择是否患有艾滋', trigger: 'change' },
					],
					'basicInfo.livingDesc':[
						{ required: true, message: '请输入儿童生活状况', trigger: 'blur' },
					],
					...
					'familyInfo.whetherNoParentInfo':[
						{ required: true, message: '请选择是否填写父母信息', trigger: 'change' },
					],
					'basicInfo.typeOfStreetChildren':[
						{ required: true, message: '请选择是否属于流浪儿童', trigger: 'change' },
					],
					// 'typeOfInfringed':[
					// 	{ required: true, message: '请选择是否被侵害', trigger: 'change' },
					// ],
					// 'typeOfJuvenileDelinquent':[
					// 	{ required: true, message: '请选择是否为失足未成年', trigger: 'change' },
					// ],
					// 'typeOfEncounteringEmergencies':[
					// 	{ required: true, message: '请选择是否遭遇突发状况', trigger: 'change' },
					// ],
					'basicInfo.collectionMethod':[
						{ required: true, message: '请选择领取方式', trigger: 'change' },
					],
					'basicInfo.receiver':[
						{ required: true, message: '请输入收领人', trigger: 'blur' },
					],	
					'basicInfo.receiverIdCard':[
						{ required: true, message: '请输入收领人身份证', trigger: 'blur' },
					],	
					'basicInfo.receiverPhone':[
						{ required: true, message: '请输入收领人电话号码', trigger: 'blur' },
					],	
					'basicInfo.receiverRelation':[
						{ required: true, message: '请输入收领人与儿童的关系', trigger: 'blur' },
					],	
				},		
			}
		},
				...
				if (this.$route.query.sId) {
                    ...
                    this.dibaoForm = {
                       "assureInfo": {
                       			...
                       			"disabilitySketch": "",
                       			"distributionCycle": "",
                       			"educationSubsidyOfMoney": 0,
                       			"financialAidForOrphansOfMoney": 0,
                       			"financialAidForPoorStudentsOfMoney": 0,
                       			"guaranteeMode": "",
                       			"guaranteeModeResume": "",
                       		...
                       		"familyInfo": {
                       			...
                       			"father": {
                       				...
                       				"reportTime": "",
                       				"reportingTime": 0,
                       				"restrictionOfPersonalFreedom": true,
                       				"seriousIllnessDesc": "",
                       				"tel": "",
                       				"termInCustody": 0,
                       				"timeRemaining": 0,
                       			...
                       			"parentMaritalStatus": "",
                       			"typesOfPoverty": "",
                       			"whetherNoParentInfo": true,
                       			"whetherPoorFamilies": true,
                       			"whetherToRemarry": true
                       		}
      ...
      changeTime2(val1,val2,val3,val4) {
          if (this.dibaoForm.familyInfo[val1][val2] && this.dibaoForm.familyInfo[val1][val3]) {
			...
			changeCid(val){
				...
				this.dibaoForm.basicInfo.birth = this.getBirthday(val);
				request({
					// headers: {
			...
			save(formName) {
				//当健康和重病同时为是的时候触发
				if(this.dibaoForm.basicInfo.whetherHealth &&  this.dibaoForm.basicInfo.whetherSeriousIllness){
					this.$message.warning("健康状态和重病状态不能同时存在");
					this.isSave=false;
					return  false;
				}
				if(this.dibaoForm.basicInfo.whetherSeriousIllness && this.dibaoForm.basicInfo.seriousIllnessType==''){
					this.$message.warning("请选择重病类型");
					this.isSave=false;
					return  false;
				}
				//当选择残疾 为是 时触发
				if(this.dibaoForm.basicInfo.whetherDisability){
					...
					//选择 否 残疾
					if(this.dibaoForm.basicInfo.disabilityType){					
						this.$message.warning("残疾状态为否 请清除选择的残疾类型");
						this.isSave=false;
						return false;
					}
					//是否选择残疾等级
					if(this.dibaoForm.basicInfo.disabilityLevel){		
						this.$message.warning("残疾状态为否 请清除选择的残疾等级");
						this.isSave=false;
						return false;
					}
				...
				this.$refs[formName].validate((valid) => {
				          if (valid) {
							  this.isSave=true
							  //alert("通过"+this.isSave)
				          } else {
				            //console.log('error submit!!');
							this.isSave=false;
							//alert("不通过"+this.isSave)
				            return false;
				          }
				});
