				...
				<el-form  v-if="isOk"  ref="Form" label-width="auto" style='padding-right: 10px;' @submit.native.prevent>
					...
					<el-row :gutter="20">
						<el-col :span="12">
							<el-form-item label="民族">
								<el-input v-model="dibaoForm.basicInfo.nation"  style="width:100%;" >
								</el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
					...
					<el-row :gutter="20">
						<el-col :span="12">
							<el-form-item label="户籍类型">
								<el-input v-model="dibaoForm.basicInfo.censusRegisterType" style="width:100%;">
					...
					<el-row :gutter="20">
						<el-col :span="12">
							<el-form-item label="儿童主任联系电话" >
								<el-input v-model="dibaoForm.basicInfo.childrenDirectorTel"  placeholder="请输入儿童主任联系电话"></el-input>
							</el-form-item>
						</el-col>
					</el-row>
                  ...
                  <!--  <h3 v-if="$route.query.type == 'bg'" class="line_blue" id="page8">&emsp;变更信息</h3>
                   ...
                   <el-row :gutter="20">
					...
					<el-row  :gutter="20">
                        <el-col :span="12">
                            <el-form-item label="教育资助(元/年)" prop="educationSubsidyOfMoney">
                                <el-input v-model="dibaoForm.assureInfo.educationSubsidyOfMoney" type="number" placeholder="请填写教育资助"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
					...
					<!-- 注销 -->
					<h3 v-if="isCancel" class="line_blue" id="page22">&emsp;注销</h3>
					<div v-if="isCancel" class="lineSt"></div>
					<div v-if="isCancel" id="recordt" style="margin-bottom:10px">
						<el-row :gutter="20">
							<el-col :span="12">
								<el-form-item label="注销原因">
									<el-input v-model="reason" type="textarea" placeholder="请填写注销原因"></el-input>
								</el-form-item>
							</el-col>							
						</el-row> 
						<br>
			...
			<div class="ainfo2">
				...
				<div style="margin-left:20px;margin-top:20px;">
					<ul>
						...
						<li v-if="isCancel" :class="{listStyle:isShow23}" @click="isShow(23)">
							<a class="ainfoFont" :class="{listStyleA:!isShow23}" @click="counter('#page23')">提交注销意见</a><br>
						</li>
					</ul>
				</div>
			</div>
