						...
						<div v-else>
							<div v-if="item.acc_ex7_1!='N'">
								<div v-if="item.acc_ex6=='修改'" class='item_1_1'>
									<div class='item_1'>数据变更情况:</div><span
										class='item_1_1 item_text'>{{item.acc_ex8}}，{{item.acc_ex1}}</span>:从<span
							...
							<div v-else style='margin-left:30px;'>
								<div v-if="item.acc_ex6=='修改'"><span class='item_text'>{{item.acc_ex8}}，{{item.acc_ex1}}</span>:从<span
										style='color:blue'>{{item.acc_ex2=="" ? "空":item.acc_ex2}}</span>变成<span
