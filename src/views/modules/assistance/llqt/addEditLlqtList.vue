	...
	<div class="g-box2">
		<div class="info2">
			<el-form :model="dibaoForm" :rules="rules" :inline-message="true" :show-message="false" ref="dibaoForm"
				...
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="登记时间" prop="ab_dat14">
							<el-date-picker v-model="dibaoForm.ab_dat14" value-format="yyyy-MM-dd" type="date" placeholder="请选择登记时间"></el-date-picker>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="救助号" prop="ab_ex12">
							<el-input v-model="dibaoForm.ab_ex12" placeholder="请输入救助号"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row :gutter="20">
					...
					<el-col :span="12">
						<el-form-item label="性别" prop="ab_ex69">
							<el-input v-model="dibaoForm.ab_ex69" placeholder="请输入性别"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="年龄" prop="ab_ex70">
							<el-input v-model="dibaoForm.ab_ex70" placeholder="请输入年龄"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
				...
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="身体状况" prop="ab_ex95">
							<el-input v-model="dibaoForm.ab_ex95" placeholder="请输入身体状况"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
				...
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="返乡时间" prop="ab_dat10">
							<el-date-picker type="date" value-format="yyyy-MM-dd"  v-model="dibaoForm.ab_dat10" placeholder="请选择返乡时间"></el-date-picker>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="联系人姓名" prop="ab_ex27">
							<el-input v-model="dibaoForm.ab_ex27" placeholder="请输入联系人姓名"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="联系人电话" prop="ab_ex28">
							<el-input v-model="dibaoForm.ab_ex28" placeholder="请输入联系人电话"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="关系" prop="ab_ex99">
							<el-input v-model="dibaoForm.ab_ex99" placeholder="请输入关系"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="安全保障情况" prop="ab_ex88">
							<el-input v-model="dibaoForm.ab_ex88" placeholder="请输入安全保障情况"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
	...
	export default {
		...
		methods: {
			...
			save() {
				...
				this.$set(this.dibaoForm,'ab_ex13','流浪乞讨救助')
				// 设置定时器，30秒请求失败刷新页面
				let time = setTimeout(()=>{
								loading.close()
								this.$emit("closes", false)
				...
				this.savevagrantBegging({
					data: JSON.stringify(this.dibaoForm),//可能不要转字符串
					ab_id: this.$route.query.sId
				}).then(res => {
					if (res[0].status=="+OK") {
						loading.close()
			...
			savevagrantBegging(data) {
				return request({
					method: 'post',
					url: '/social/assistance/otherRescue/savevagrantBegging',
					data: data
				})
			},
			isCardID(sId){
