		...
		<div class="info2">
			<el-form :model="dibaoForm" :rules="rules" :inline-message="true" :show-message="false" ref="dibaoForm"
				...
				<el-row :gutter="20">
					...
					<el-col :span="12">
						<el-form-item label="社会组织" prop="ab_ex115">
							<el-input v-model="dibaoForm.ab_ex115" placeholder="请输入社会组织"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="救助时间" prop="ab_dat18">
							<el-date-picker v-model="dibaoForm.ab_dat18" value-format="yyyy-MM-dd" type="date" placeholder="请选择救助时间"></el-date-picker>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="救助内容" prop="ab_ex87">
							<el-input v-model="dibaoForm.ab_ex87" placeholder="请输入救助内容"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
	...
	export default {
		...
		methods: {
			...
			save() {
				...
				this.$set(this.dibaoForm,'ab_ex13','社会组织救助')
				// 设置定时器，30秒请求失败刷新页面
				let time = setTimeout(()=>{
								loading.close()
								this.$emit("closes", false)
			...
			saveBasic2(data) {
				return request({
					method: 'post',
					url: '/social/assistance/otherRescue/saveBasic2',
					data: data
				})
			},
			isCardID(sId){
