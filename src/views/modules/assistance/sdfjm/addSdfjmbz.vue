	...
	<div class="g-box2">
		<div class="info2">
			<el-form :model="dibaoForm" :rules="rules" :inline-message="true" :show-message="false" ref="dibaoForm"
				...
				<el-row :gutter="20">
					<el-col>
						<el-form-item label="请输入减免标准" prop="abs_ex5">
							<el-input v-model="dibaoForm.abs_ex5" placeholder="请输入减免标准"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
