		...
		<div class="info2">
			<el-form :model="dibaoForm" :rules="rules" :inline-message="true" :show-message="false" ref="dibaoForm"
				...
				<el-row :gutter="20">
					...
					<el-col :span="12">
						<el-form-item label="病种" prop="ab_ex83">
							<el-input v-model="dibaoForm.ab_ex83" placeholder="请输入病种"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="金额" prop="ab_ex84">
							<el-input v-model="dibaoForm.ab_ex84" placeholder="请输入金额"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="户口性质" prop="ab_ex6">
							<el-select v-model="dibaoForm.ab_ex6" placeholder="请选择户口性质">
								<el-option value="农业户口"></el-option>
								<el-option value="非农业户口"></el-option>
							</el-select>
						</el-form-item>
					</el-col>
				</el-row>
				...
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="备注" prop="ab_ex88">
							<el-input v-model="dibaoForm.ab_ex88" placeholder="请输入备注"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
	...
	export default {
		...
		methods: {
			...
			save() {
				...
				this.$set(this.dibaoForm,'ab_ex13','医疗应急救助')
				// 设置定时器，30秒请求失败刷新页面
				let time = setTimeout(()=>{
								loading.close()
								this.$emit("closes", false)
