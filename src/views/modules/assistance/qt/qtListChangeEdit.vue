	...
	<div class="g-box">
		<div class='g-box2'>
			...
			<el-form :model="dibaoForm" :rules="rules" ref="dibaoForm" label-width="auto" style='padding-right: 10px;'>
				...
				<h3 class="line_blue" id="page9" style='margin-top:15px'>&emsp;变更信息</h3>
				<div class="lineSt"></div>
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label='变更理由'>
							<el-select v-model='changeM.ac_ex10' placeholder='请选择'>
								<el-option label='补充信息' value='补充信息'></el-option>
				...
				<el-table :data="familyData1" border :row-class-name="rowClassName"
					...
					<el-table-column prop="abm_ex16" label="民族" min-width="100">
						<template slot-scope="scope">
				...
				<el-row :gutter="20" style='margin-top:10px'>
					...
					<el-col :span="12" class="my-col">
						...
						<el-card class="box-card">
							...
							<div class="block">
								<image-view :imgList="uploadImg.ab_e16_img"></image-view>
							</div>
						</el-card>
					</el-col>
				</el-row>
			...
			<div style="margin-left:20px;margin-top:20px;">
				<ul>
					...
					<li :class="{listStyle:isShow8}" @click="isShow(8)">
						<!-- <a class="ainfoFont" :class="{listStyleA:!isShow8}" href="#page8">救助核算</a><br> -->
					...
					<li :class="{listStyle:isShow9}" @click="isShow(9)">
						<a class="ainfoFont" :class="{listStyleA:!isShow9}" @click="counter('#page9')">变更信息</a><br>
					</li>
			...
			getJZMoney(knType) {
				...
				switch (knType) {
					case "因病支出型困难家庭":
						...
						m = pro1_5;
						m = inputV <= 20000 ? (pro1_5 > v ? pro1_5 : (pro3 < v ? pro3 : v)) : ((inputV * 0.1) > pro15 ?
							pro15 : (inputV * 0.1));
						this.dibaoForm.ab_ex108 = m.toFixed(2)
					...
					case "因灾急难型困难家庭":
						...
						m = inputV <= 20000 ? (pro1_5 > v ? pro1_5 : (pro3 < v ? pro3 : v)) : ((inputV * 0.1) > pro12 ?
							pro12 : (inputV * 0.1));
						this.dibaoForm.ab_ex110 = m.toFixed(2);
						console.log(ab_ex38)
						break;
