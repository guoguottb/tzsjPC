				...
				<el-form :inline="true" class="demo-form-inline">
							...
							<el-row>
								<el-col :span="12">
									<el-card class="box-card">
										...
										<image-view :imgList="this.basicInf.ab_ex10.split(',')" height="150px"
								...
								<el-col :span="12">
									<el-card class="box-card">
										...
										<image-view :imgList="this.basicInf.ab_ex73.split(',')" height="150px"
											width="150px"></image-view>
							...
							<el-row>
								<el-col :span="12">
									<el-card class="box-card">
										...
										<image-view :imgList="this.basicInf.ab_ex97.split(',')" height="150px"
											width="150px"></image-view>
								...
								<el-col :span="12">
									<el-card class="box-card">
										...
										<image-view :imgList="this.basicInf.ab_ex16.split(',')" height="150px"
											width="150px"></image-view>
							...
							<el-row>
								...
								<el-col :span="12">
									<el-card class="box-card">
										...
										<image-view :imgList="this.basicInf.ab_ex98.split(',')" height="150px"
											width="150px"></image-view>
								...
								<el-col :span="12">
									<el-card class="box-card">
										...
										<image-view :imgList="this.basicInf.ab_ex154.split(',')" height="150px"
											width="150px"></image-view>
					...
					<div class="top_1" v-if="this.type == 'cs'">
						<el-row>
							...
							<el-col :span="6">
								<el-date-picker v-model="auditValue.ab_dat4" type="datetime"
					...
					<div class="top_1" v-if="this.type == 'th'">
						<el-row>
							...
							<!-- <el-col :span="16"><el-input placeholder="yyyy-MM-dd" v-model="auditValue.ab_dat4"></el-input></el-col> -->
							<el-col :span="6">
								<el-date-picker v-model="auditValue.ab_dat4" type="date" value-format="yyyy-MM-dd"
									placeholder="选择审核时间">
								</el-date-picker>
							</el-col>
						</el-row>
					...
					<div class="top_1" v-if="this.type == 'gs'">
						<el-row>
							...
							<el-col :span="6">
								<el-date-picker v-model="publicity.ab_dat9" type="date" size="small"
									value-format="yyyy-MM-dd" styele="width:90%" placeholder="选择公示开始时间">
								</el-date-picker>
							</el-col>
						</el-row>
						<el-row style='margin-top:10px'>
							...
							<el-col :span="6">
								<el-date-picker v-model="publicity.ab_dat10" type="date" value-format="yyyy-MM-dd"
					...
					<div class="top_1" v-if="this.type == 'sp'">
						<el-row>
								...
								<el-col :span="6">
									<!-- <el-input placeholder="yyyy-MM-dd" v-model="approval.ab_dat5"></el-input> -->
									<el-date-picker
