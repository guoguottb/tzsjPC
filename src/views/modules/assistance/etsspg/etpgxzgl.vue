  	...
  	<div class="g-box"> 
		...
		<div class="search">
			<el-form :inline="true" :model="searchData" class="demo-form-inline">
                ...
                <el-form-item label-width="110px" label="小组名称" >
				...
				<el-form-item label-width="110px"  >
                    ...
                    <el-button type="info" @click="resetQuery" icon="el-icon-refresh" >
						重置</el-button >
                    <el-button type="primary" @click="addGroup" icon="el-icon-menu" >
		...
		style="width: auto" @selection-change="handleSelectionChange" height="100%" v-loading="loading">
			...
			<el-table-column prop="leader" label="组长" width='100px'></el-table-column>
			<el-table-column prop="persons" label="小组成员" width="180px"> </el-table-column>
			<el-table-column prop="title" label="小组名称" width="120px"></el-table-column>
          ...
          <div class="content">
            <div v-for="(item,index) in [groupObj] " :key="index"  >
                <el-form ref="item" :model="item" label-width="100px" :rules="rules" class="Card" >
                    ...
                    <el-form-item label="小组成员"  prop="memberIds">
                        <!-- <el-input v-model="item.memberIds"></el-input> -->
                         <el-select v-model="groupObj.memberIds" @change="seeList('组员')"  multiple filterable placeholder="请选择" style="width:100%">
                    ...
                    <el-form-item label="小组长"  prop="leaderId">
                        <!-- <el-input v-model="item.leaderId" ></el-input> -->
                         <el-select v-model="groupObj.leaderId" @change="seeList('组长')" filterable placeholder="请选择" style="width:100%">
                            <el-option 
