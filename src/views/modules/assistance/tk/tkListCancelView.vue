			...
			<el-form :inline="true" class="demo-form-inline">
				...
				<div class="top_1" v-if="this.type == 'cs'">
					...
					<el-row style="margin-top: 10px;">
						...
						<el-col :span="20"><el-input type="textarea" autosize v-model="auditValue.ac_ex2"></el-input></el-col>
					</el-row>
				...
				<div class="top_1" v-if="this.type == 'zx'">
					<el-row>
						<el-col :span="2" style="line-height: 30px;"><div>注销时间</div></el-col>
						<!-- <el-col :span="16"><el-input placeholder="yyyy-MM-dd" v-model="publicity.ac_dat1"></el-input></el-col> -->
						<el-col :span="16">
							<el-date-picker
					...
					<el-row style="margin-top: 10px;">
						<el-col :span="2" style="line-height: 30px;"><div>注销原因</div></el-col>
				...
				<div class="top_1" v-if="this.type == 'sp'">
					...
					<el-row style="margin-top: 10px;">
						<el-col :span="2" style="line-height: 30px;"><div>备注</div></el-col>
						<el-col :span="20"><el-input type="textarea" autosize v-model="approval.ac_ex5"></el-input></el-col>
					</el-row>
					<el-row style="margin-top: 10px;" type="flex" justify="center">
			...
			<div style="margin-left:25%;margin-top:20px;">
				<ul>
					...
					<li :class="{listStyle:isShow14}" @click="isShow(14)">
						<a class="ainfoFont" :class="{listStyleA:!isShow14}" @click="counter('#page14')">自定义预警信息</a><br>
					</li>
					...
					<li :class="{listStyle:isShow15}" @click="isShow(15)">
						<a class="ainfoFont" :class="{listStyleA:!isShow15}" @click="counter('#page15')">非共同生活赡抚扶养人家庭成员信息</a><br>
					</li>
					<!-- <li :class="{listStyle:isShow13}" @click="isShow(13)">
						<a class="ainfoFont" :class="{listStyleA:!isShow13}" @click="counter('#page13')">监护人信息</a><br>
					</li> -->
					...
					<li :class="{listStyle:isShow16}" @click="isShow(16)">
						<a class="ainfoFont" :class="{listStyleA:!isShow16}" @click="counter('#page16')">家庭前12个月支出情况</a><br>
					</li>
					...
					<li :class="{listStyle:isShow17}" @click="isShow(17)">
						<a class="ainfoFont" :class="{listStyleA:!isShow17}" @click="counter('#page17')">拥有车、船情况</a><br>
					</li>
					<li :class="{listStyle:isShow18}" @click="isShow(18)">
						<a class="ainfoFont" :class="{listStyleA:!isShow18}" @click="counter('#page18')">拥有房产情况</a><br>
					</li>
	...
	export default {
		...
		methods: {
			scroll(){
				...
				let oDiv12 = this.type =='zx'?true:document.querySelector('#page12');
				...
				console.log(document.querySelector('.info2')==null , document.querySelector('#recordt')==null,'滑动111')
				// 顺序跟上面显示顺序要相反
				...
				if(!oDiv1 || !oDiv2 || !oDiv3 || !oDiv4 || !oDiv5 || !oDiv6 || !oDiv7 || !oDiv8 || !oDiv9 || !oDiv10|| !oDiv12|| !oDiv14|| !oDiv15|| !oDiv16|| !oDiv17|| !oDiv18){
					return ''
				}
				...
				else if (scrollTop > (oDiv12.offsetTop-oDiv1.offsetTop-1) && this.type!='zx'){
					// console.log('触发了12')
					this.isShow(12)
				}
