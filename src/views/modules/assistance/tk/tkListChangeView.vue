	...
	<div class="g-box" v-loading="loading">
		<div class='g-box2'>
			...
			<el-form :inline="true" class="demo-form-inline">
                ...
                <h3 class="line_blue" id="page18" style='margin-top:20px'>&emsp;变更报告</h3>
				<div class="lineSt"></div>
				<div class="top_1" style='width:95%'>
                    <div class='change_item' v-for="(item,index) in changeChild" :key="index">
                        ...
                        <!-- <div v-else>
                            <div v-if="item.acc_ex7_1!='N'">
                                <div v-if="item.acc_ex6=='修改'"  class='item_1_1'><div class='item_1'>{{item.acc_ex8}}的数据变更情况:</div><span  class='item_1_1 item_text'>{{item.acc_ex1}}</span>:从<span style='color:blue'>{{item.acc_ex2=="" ? "空":item.acc_ex2}}</span>变成<span style='color:green'>{{item.acc_ex3}}</span>；</div>
                                <div v-else-if="item.acc_ex6=='删除'"  class='item_1_1'><div  class='item_1'>删除数据：</div><span  class='item_1_1 item_text'>{{item.acc_ex1}}</span>:{{item.acc_ex2}};</div>
                                <div v-else  class='item_1_1'><div  class='item_1'>新增数据：</div><span  class='item_1_1 item_text'>{{item.acc_ex1}}</span>:{{item.acc_ex3}};</div>
                            </div>
                            <div v-else style='margin-left:30px;'>
                                 ...
                                 <div v-else-if="item.acc_ex6=='删除'" >
                                     <div v-if="item.acc_ex2!=''"  ><span class='item_text'>{{item.acc_ex1}}</span>:{{item.acc_ex2}};</div>
                                 </div>
				...
				<div class="top_1" v-if="this.type == 'cs'">
					<el-row>
							<el-col :span="2"><div style="line-height: 30px;">审核意见</div></el-col>
							<el-col :span="6">
								<el-select @change="changeSh" v-model="auditValue.ac_ex4" placeholder="请选择">
									<el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value"></el-option>
								</el-select>
							</el-col>
							<el-col :span="2"><div style="line-height: 30px;">审核人</div></el-col>
							<el-col :span="6"><el-input v-model="auditValue.ac_ex6"></el-input></el-col>
							<el-col :span="2" style="line-height: 30px;"><div>审核时间</div></el-col>
							<!-- <el-col :span="16"><el-input placeholder="yyyy-MM-dd" v-model="auditValue.ac_dat2"></el-input></el-col> -->
							<el-col :span="6">
								<el-date-picker
					...
					<el-row style="margin-top: 10px;">
						<el-col :span="2" style="line-height: 30px;"><div>备注</div></el-col>
						<el-col :span="20"><el-input type="textarea" autosize v-model="auditValue.ac_ex5"></el-input></el-col>
					</el-row>
				...
				<div class="top_1" v-if="this.type == 'th'">
					...
					<el-row style="margin-top: 10px;">
						<el-col :span="2" style="line-height: 30px;"><div>退回原因</div></el-col>
						<el-col :span="20"><el-input type="textarea" autosize v-model="auditValue.ac_ex5"></el-input></el-col>
					</el-row>
					<el-row style="margin-top: 10px;" type="flex" justify="center">
						<el-col :span="24" style="text-align: center;"><el-button type="primary" @click="save(auditValue)">保存</el-button></el-col>
				...
				<div class="top_1" v-if="this.type == 'sp'">
					...
					<el-row style="margin-top: 20px;">
						<el-col :span="2"><div style="line-height: 30px;">审批意见</div></el-col>
						<el-col :span="6">
							<el-select @change="changeSh" v-model="approval.ac_ex7" placeholder="请选择">
								<el-option v-for="item in options3" :key="item.value" :label="item.label" :value="item.value"></el-option>
							</el-select>
						</el-col>
						<el-col :span="2"><div style="line-height: 30px;">审批人</div></el-col>
						<el-col :span="6"><el-input v-model="approval.ac_ex9"></el-input></el-col>
						<el-col :span="2" style="line-height: 30px;"><div>审批时间</div></el-col>
						<!-- <el-col :span="16"><el-input placeholder="yyyy-MM-dd" v-model="approval.ac_dat3"></el-input></el-col> -->
						<el-col :span="6">
							<el-date-picker
					...
					<el-row style="margin-top: 10px;">
						<el-col :span="2" style="line-height: 30px;"><div>备注</div></el-col>
						<el-col :span="20"><el-input type="textarea" autosize v-model="approval.ac_ex8"></el-input></el-col>
					</el-row>
					<el-row style="margin-top: 10px;" type="flex" justify="center">
			...
			<div style="margin-left:25%;margin-top:20px;">
				<ul>
					...
					<li :class="{listStyle:isShow14}" @click="isShow(14)">
						<a class="ainfoFont" :class="{listStyleA:!isShow14}" @click="counter('#page14')">监护人情况</a><br>
					</li>
					...
					<li :class="{listStyle:isShow18}" @click="isShow(18)">
						<a class="ainfoFont" :class="{listStyleA:!isShow18}" @click="counter('#page18')">变更报告</a><br>
					</li>
					<li :class="{listStyle:isShow9}" @click="isShow(9)">
						<a class="ainfoFont" :class="{listStyleA:!isShow9}" @click="counter('#page9')">电子附件</a><br>
					</li>
					<li :class="{listStyle:isShow11}" @click="isShow(11)" v-if="type=='cs'||type=='th'||type=='gs'||type=='sp'">
	...
	export default {
		...
		methods: {
			scroll(){
				...
				if(!oDiv1 || !oDiv2 || !oDiv3 || !oDiv4 || !oDiv5 || !oDiv6 || !oDiv7 || !oDiv8 || !oDiv9 || !oDiv10|| !oDiv12|| !oDiv13|| !oDiv14|| !oDiv15|| !oDiv16|| !oDiv17|| !oDiv18){
					return ''
				}
