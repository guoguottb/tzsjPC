		...
		<div class="info2">
			<el-form :model="dibaoForm" :rules="rules" :inline-message="true" :show-message="false" ref="dibaoForm"
				...
				<el-row :gutter="20">
					...
					<el-col :span="12">
						<el-form-item label="职工姓名" prop="ab_ex3">
							<el-input v-model="dibaoForm.ab_ex3" placeholder="请输入职工姓名"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row :gutter="20">
		...
		methods: {
			...
			save() {
				...
				if(this.dibaoForm.ab_ex7){
					...
					if(msg){
						this.$message.warning("职工"+msg);
						return false
					}
				}
				this.$set(this.dibaoForm,'ab_ex13',"下放职工")
