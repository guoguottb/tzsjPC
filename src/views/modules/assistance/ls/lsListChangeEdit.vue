		...
		<div class='g-box2'>
			...
			<el-row :gutter="20">
				...
				<el-row :gutter='20' v-else-if='dibaoForm.ab_ex122 == "因灾急难型困难家庭" '>
					...
					<el-col :span='12'>
						<el-form-item label='救助金额'>
							<el-input type="number" v-model="dibaoForm.ab_ex110" @change='getJZMoney("因灾急难型困难家庭")'>
							</el-input>
						</el-form-item>
					</el-col>
				</el-row>
	...
	export default {
		...
		methods: {
			...
			computeMoney(data){
				...
				for(let i in this.familyData1){
					...
					if( this.dibaoForm.ab_ex13 =='低保' || this.jsjgString == '最低生活保障-按户保' || this.ab_ex13=='低保'){
						...
						console.log(this.familyData1[i].abm_ex71=='是','渐退期-71');
						console.log(this.dibaoForm.ab_ex207,'渐退期');
			...
			changeJS(){
				...
				console.log(this.incomeConstant,'人均可支配常数-after');
			...
			async save() {
				...
				if(this.dibaoForm.ab_ex13=='家庭边缘'){
					...
					ab_ex13_type = this.dibaoForm.ab_ex13;
				}
				...
				if(!this.assistanceType){
					...
					this.setType = this.dibaoForm.ab_ex3 + "您当前救助类型为："+ab_ex13_type+"，政策计算器检测到您可能符合：<b>" + this.assistanceType + '</b	>，是否继续保存？'
			...
			async save2(){
				...
				if(this.jsjgString.indexOf('特困人员供养')!=-1 &&  (this.ab_x13=='' || this.ab_x13==undefined)){
					this.$alert('请选择一个救助类别');
					return false;
				}

				this.computeMoney()
				console.log(this.dibaoForm.ab_ex40);
