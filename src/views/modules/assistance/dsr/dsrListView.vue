		...
		<div class='g-box2'>
			...
			<el-form :inline="true" class="demo-form-inline">
						...
						<el-col :span="24">
									<span>
										...
										(<el-radio-group    style="margin: 0 5px" v-model="typeData.ab_ex41">
											...
											<el-radio label="残疾人单列户施保" >残疾人单列户施保</el-radio>
											<el-radio label="重病型单列户施保" >重病型单列户施保</el-radio>
										</el-radio-group>)
									</span>
						</el-col>
					</el-row>
				...
				<div class="top_1" v-if="this.type == 'th'">
					...
					<el-row style="margin-top: 10px;" type="flex" justify="center">
						<el-input v-if="false" v-model="auditValue.ab_ex15"></el-input>
						<el-col :span="24" style="text-align: center;">
							<el-button type="primary" @click="save(auditValue)">保存</el-button>
						</el-col>
					</el-row>
					...
					<el-row style="margin-top: 10px;">
						<el-col :span="20" :offset="2">
								<el-card class="box-card">
									...
									<div class="block">
										<image-view :imgList="publicity.ab_ex97.split(',')"></image-view>
									</div>
								</el-card>
						</el-col>
					</el-row>
		...
		methods: {
			...
			loadData() {
				...
				this.getData({
					...
					console.log(res.response.data,'------------this.basicInf')
			...
			save2(data) {
				...
				// }
				console.log(data)
				// console.log(data.ab_ex34);
				if (data.ab_ex34 == "") {
					this.$message.error('请选择公示结果');
				} 
				else if(data.ab_ex34=="有异议退回"){
					console.log(data.ab_ex34=="有异议退回");
					if(data.ab_ex98){
