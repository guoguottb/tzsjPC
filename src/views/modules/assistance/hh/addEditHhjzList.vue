		...
		<div class="info2">
			<el-form :model="dibaoForm" :rules="rules" :inline-message="true" :show-message="false" ref="dibaoForm"
				...
				<el-row :gutter="20">
					...
					<el-col :span="12">
						<el-form-item label="救助原因" prop="ab_ex87">
							<el-input v-model="dibaoForm.ab_ex87" placeholder="请输入救助原因"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="户口性质" prop="ab_ex6">
							<el-select v-model="dibaoForm.ab_ex6" placeholder="请输入户口性质">
	...
	export default {
		...
		methods: {
			...
			save() {
				...
				this.$set(this.dibaoForm,'ab_ex13','红会救助')
				// 设置定时器，30秒请求失败刷新页面
				let time = setTimeout(()=>{
								loading.close()
								this.$emit("closes", false)
