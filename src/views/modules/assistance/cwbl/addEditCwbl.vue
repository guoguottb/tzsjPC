				...
				if(!this.isTest){  
					...
					if(this.income6.length>0){
						for(let i=0; this.income6.length>i;i++){
							...
							// else if(!abi_ex1 && abi_ex2){
							// 	this.$message.warning("请将第"+(Number(i)+1)+"行必要就业成本抵扣称补充完整");
							// 	isSave=false;
							// 	this.isSaves=false
							// 	return false;
							// }
					...
					// if(this.pay.abp_ex9==""){
					// 	this.$message.warning("家庭前12个月支出情况，扣减刚性支出后家庭年收入不能为空");
					// 	isSave=false;
					// 	this.isSaves=false;
					// 	return false;
					// } 
					// if(this.pay.abp_ex10==""){
					// 	this.$message.warning("家庭前12个月支出情况，扣减刚性支出后人均年收入不能为空");
					// 	isSave=false;
					// 	this.isSaves=false;
					// 	return false;
					// } 
