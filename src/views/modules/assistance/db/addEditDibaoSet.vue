	...
	<div class="g-box2">
		<div class="info2">
			<el-form :model="dibaoForm" :rules="rules" :inline-message="true" :show-message="false" ref="dibaoForm"
				...
				<h3 class="line_blue" id="page1">&emsp;标准信息</h3>
				<div class="lineSt"></div>
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="标准金额" prop="as_ex1">
							<el-input v-model="dibaoForm.as_ex1" placeholder="请输入标准金额"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="标准类型" prop="as_ex4">
							<el-input v-model="dibaoForm.as_ex4" placeholder="请输入标准类型"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="执行时间" prop="as_dat2">
							<el-date-picker type="date" v-model="dibaoForm.as_dat2" value-format="yyyy-MM-dd"
								style="width: 100%;">
							</el-date-picker>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="停用时间" prop="as_dat3">
							<el-date-picker type="date" v-model="dibaoForm.as_dat3" value-format="yyyy-MM-dd"
								style="width: 100%;">
							</el-date-picker>
						</el-form-item>
					</el-col>
				...
				<el-row :gutter="20">
					<el-col :span="24">
						<!-- 唉，我没保存到后端，我就让你填，就是玩 -->
						<!-- 先在前台显示，后续在保存到后端 -->
						<el-form-item label="依据说明" prop="as_ex6">
							<el-input type='textarea' v-model="dibaoForm.as_ex6" :rows='8' placeholder="请填写相关标准依据说明"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
...
<script>
	...
	export default {
		...
		methods: {
			...
			loadData() {
				this.getCommonData({
					table: "assistance_standard",
					id: "as_id",
					idVal: this.$route.query.sId,
				}).then(res => {
					console.log(res)
			...
			getCommonData(data) {
				return request({
					method: 'post',
					url: '/social/weida/getCommonData',
					data: data
				})
			},
			isShow(n) {
