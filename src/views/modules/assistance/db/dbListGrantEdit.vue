				...
				<el-form :inline="true" class="demo-form-inline">
								...
								<el-col :span="20" :offset="2">
										<el-card class="box-card">
											<div slot="header" style="text-align:center" class="clearfix">
												...
												<span><span style="color:red"> * </span>退回材料(<span style='color:red'>{{imgNum.ab_ex175_len}}</span>)</span>
					...
					<el-dialog title="转办数据完善" center :visible.sync="dialogChangeForm" :before-close="giveUpZB" z-index=1999  width=80% class="change_type">
						...
						@selection-change="handleFamilyData1"  empty-text='空' class="my-table">
							...
							<el-table-column prop="abm_ex49" label="劳动能力" min-width="160">
								<template slot-scope="scope">
									<el-select v-model="tableData[scope.row.xh-1].abm_ex49" :disabled="scope.row.abm_ex1=='户主'" >
										<el-option label="请选择" value=""></el-option>
					...
					<div class="top_1" v-if="this.type == 'gs'">
						...
						<el-row>
							...
							<el-col :span="2" style="line-height: 30px;;text-align:center">
								<div><span style="color:red"> * </span>公示开始时间</div>
							</el-col>
							<el-col :span="6">
								<el-date-picker
						...
						<el-row style='margin-top:10px'>
							<el-col :span="2" style="line-height: 30px;text-align:center">
								<div><span style="color:red"> * </span>公示结束时间</div>
							</el-col>
							<el-col :span="6">
								<el-date-picker
							...
							<el-col :span="12">
								<el-card class="box-card">
									<div slot="header" style="text-align:center" class="clearfix">
										...
										<span><span  v-if="publicity.ab_ex34=='有异议退回'" style="color:red"> * </span>公示图片(<span style='color:red'>{{imgNum.ab_ex98_len}}</span>)</span>
					...
					<template v-if="this.approval.ab_ex13=='特困供养'">
						...
						<div class="top_1" v-if="this.type == 'sp'">
							<el-row :gutter="20" style="text-align:center;margin-bottom:10px">
								...
								<el-col :span="2">
									<div style="line-height: 30px;"><span style="color:red"> * </span>护理费</div>
								</el-col>
								<el-col :span="6">
								...
								<el-col :span="2">
									<div style="line-height: 30px;"><span style="color:red"> * </span>供养机构</div>
								</el-col>
								<el-col :span="6">
							...
							<el-row :gutter="20" style="text-align:center">
								...
								<el-col :span="2">
									<div style="line-height: 30px;"><span style="color:red"> * </span>生活费</div>
								</el-col>
								<el-col :span="6">
									<el-input v-model="approval.ab_ex200" placeholder="请输入生活费" @change="keyVerification(approval.ab_ex200,'ab_ex200')"></el-input>
								</el-col>
                    ...
                    <h3 class="line_blue" id="">&emsp;资金发放</h3>
					<div class="lineSt"></div>
		...
		methods: {
			...
			loadData() {
				...
				this.getData({
					...
					// 没有保障金时设置为0
					this.basicInf.ab_ex40 = this.basicInf.ab_ex40 == '' ? "0" : this.basicInf.ab_ex40;
					console.log('保障金=>',this.basicInf.ab_ex40);
			...
			keyVerification(key,id){
				...
				// 生活费
				if(id=='ab_ex200'){
					this.approval.ab_ex200 = key.replace(/\s+/g,""); 
					msg=isNum(key,id);
					if(msg!=true){
						this.$message.warning(msg);
						this.isSave=false;
			...
			save(data) {
				...
				if(data.ab_ex27=="退回"){
					...
					// else if(data.ab_ex27=="退回" && data.ab_ex175==''){
