		...
		<div class="info2">
			<el-form :model="dibaoForm" :rules="rules"  :inline-message="true" :show-message="false" ref="dibaoForm" label-width="auto" style='padding-right: 10px;'>
				...
				<el-row :gutter="20">
					...
					<el-col :span="12">
						<el-form-item label="预警时间1" prop="aw_ex1" disabledDate>
					...
					<el-table :data="income1" border :row-class-name="rowClassName" @selection-change="handleIncome1" empty-text='空' class="my-table">
						<el-table-column label="工资性收入（年）" align="center"  >
							...
							<el-table-column label="金额" prop="abi_ex2" min-width="145" >
								<template slot-scope="scope">
									<el-input v-model="income1[scope.row.xh-1].abi_ex2" @change="changeAmt"></el-input>
								</template>
							</el-table-column>
						</el-table-column>
				...
				<div>
					...
					<el-table :data="income3" border :row-class-name="rowClassName" @selection-change="handleIncome3" empty-text='空' class="my-table">
						<el-table-column label="财产净收入（年）" align="center">
							<el-table-column type="selection" min-width="40" align="center" />
							<el-table-column label="计入收入名称" prop="abi_ex1" min-width="145" >
								<template slot-scope="scope">
							...
							<el-table-column label="金额" prop="abi_ex2" min-width="145" >
								<template slot-scope="scope">
									<el-input v-model="income3[scope.row.xh-1].abi_ex2" @change="changeAmt"></el-input>
								</template>
							</el-table-column>
						</el-table-column>
				...
				<div>
					...
					<el-table :data="income4" border :row-class-name="rowClassName" @selection-change="handleIncome4" empty-text='空' class="my-table">
						<el-table-column label="转移净收入（年）" align="center">
							...
							<el-table-column label="金额" prop="abi_ex2" min-width="145" >
								<template slot-scope="scope">
									<el-input v-model="income4[scope.row.xh-1].abi_ex2" @change="changeAmt"></el-input>
								</template>
							</el-table-column>
						</el-table-column>
					</el-table>
				...
				<div >
					<el-table :data="income2" border :row-class-name="rowClassName" @selection-change="handleFamilyData3" empty-text='空' class="my-table">
						<el-table-column label="经营净收入（年）" align="center">
							...
							<el-table-column label="金额" prop="abi_ex2" min-width="145" >
								<template slot-scope="scope">
									<el-input v-model="income2[scope.row.xh-1].abi_ex2" @change="changeAmt"></el-input>
								</template>
							</el-table-column>
						</el-table-column>
					</el-table>
				...
				<div>
					<el-table :data="income5" border :row-class-name="rowClassName" @selection-change="handleFamilyData3" empty-text='空' class="my-table">
						<el-table-column label="其他收入（年）" align="center">
							<el-table-column label="计入收入名称" prop="abi_ex1" min-width="140">
								<template slot-scope="scope">
									<el-input v-model="income5[scope.row.xh-1].abi_ex1"></el-input>
								</template>
							</el-table-column>
							<el-table-column label="金额" prop="abi_ex2" min-width="145" >
								<template slot-scope="scope">
									<el-input v-model="income5[scope.row.xh-1].abi_ex2" @change="changeAmt"></el-input>
								</template>
							</el-table-column>
						</el-table-column>
					</el-table>
				...
				<div>
					<el-table :data="income6" border :row-class-name="rowClassName" @selection-change="handleFamilyData3" empty-text='空' class="my-table">
						<el-table-column label="必要就业成本抵扣" align="center">
							<el-table-column label="计入收入名称" prop="abi_ex1" min-width="140">
								<template slot-scope="scope">
									<el-input v-model="income6[scope.row.xh-1].abi_ex1"></el-input>
								</template>
							</el-table-column>
							<el-table-column label="金额" prop="abi_ex2" min-width="145" >
								<template slot-scope="scope">
									<el-input v-model="income6[scope.row.xh-1].abi_ex2" @change="changeAmt"></el-input>
								</template>
							</el-table-column>
							<!-- <el-table-column label="操作" prop="abi_ex1" min-width="145" ></el-table-column> -->
				...
				<div>
					<el-table :data="income7" border :row-class-name="rowClassName" @selection-change="handleFamilyData3" empty-text='空' class="my-table">
						<el-table-column label="总收入" align="center">
							...
							<el-table-column label="金额" prop="abi_ex2" min-width="145" >
								<template slot-scope="scope">
									<el-input v-model="income7[scope.row.xh-1].abi_ex2"></el-input>
								</template>
							</el-table-column>
						</el-table-column>
					</el-table>
	...
	export default {
		...
		methods: {
			...
			loadData() {// 进入页面加载数据
				...
				this.getBasic({
					...
					this.loadWarning({
						...
						this.warningData = res.response.data[0].data;
				...
				this.loadEstate({
					...
					console.log(res)
					for(let i in res.response.data[0].data){
						// console.log(res.response.data[0].data[i].abe_ex7)
			...
			changeAmt(total) {
				...
				// }
				// 家庭收入
				// var ab_ex29 = Number(this.dibaoForm.ab_ex29);//shift+F12快速查找所有引用
				...
				for(let i in this.income1 ){
					if(this.income1[i].abi_ex2!=""&& !isNaN(Number(this.income1[i].abi_ex2)) ){
						...
						console.log(this.income1[i].abi_ex2);
				...
				for(let i in this.income2 ){
					if(this.income2[i].abi_ex2!=""&& !isNaN(Number(this.income1[i].abi_ex2)) ){
						len++;
						abi_ex2_2+=Number(this.income2[i].abi_ex2) 
						console.log(this.income2[i].abi_ex2);
						console.log(abi_ex2_2);
					}else if(len==0){
						abi_ex2_2=0;
					}
					// console.log( this.income1);
				...
				for(let i in this.income3 ){
					if(this.income3[i].abi_ex2!=""&& !isNaN(Number(this.income1[i].abi_ex2)) ){
						len++;
						abi_ex2_3+=Number(this.income3[i].abi_ex2) 
						console.log(this.income3[i].abi_ex2);
						console.log(abi_ex2_3);
					}else if(len==0){
						abi_ex2_3=0;
					}
				...
				for(let i in this.income4 ){
					if(this.income4[i].abi_ex2!="" && !isNaN(Number(this.income1[i].abi_ex2)) ){
						len++;
						abi_ex2_4+=Number(this.income4[i].abi_ex2) 
						console.log(this.income4[i].abi_ex2);
						console.log(abi_ex2_4);
					}else if(len==0){
						abi_ex2_4=0;
					}
				...
				for(let i in this.income5 ){
					if(this.income5[i].abi_ex2!="" && !isNaN(Number(this.income1[i].abi_ex2)) ){
						len++;
						abi_ex2_5+=Number(this.income5[i].abi_ex2) 
						console.log(this.income5[i].abi_ex2);
						console.log(abi_ex2_5);
					}else if(len==0){
						abi_ex2_5=0;
					}
				...
				for(let i in this.income6 ){
					if(this.income6[i].abi_ex2!=""&& !isNaN(Number(this.income1[i].abi_ex2)) ){
						len++;
						abi_ex2_6+=Number(this.income6[i].abi_ex2) 
						console.log(this.income6[i].abi_ex2);
						console.log(abi_ex2_6);
					}else if(len==0){
						abi_ex2_6=0;
					}
				...
				if(this.familyData1.length>0){
					this.income7[2].abi_ex2=amt/12/this.familyData1.length;
				}else{
			...
			this.saveBasic({
					...
					"income":  JSON.stringify(this.income1.concat(this.income2).concat(this.income3).concat(this.income4).concat(this.income5).concat(this.income6).concat(this.income7)),
