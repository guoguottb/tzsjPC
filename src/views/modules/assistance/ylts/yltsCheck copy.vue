					...
					<el-table :data="income1" border :row-class-name="rowClassName" @selection-change="handleIncome1" empty-text='空' class="my-table">
						<el-table-column label="工资性收入（年）" align="center"  >
							...
							<el-table-column label="金额" prop="abi_ex2" min-width="145" >
								<template slot-scope="scope">
									<el-input v-model="income1[scope.row.xh-1].abi_ex2" @change="changeAmt(scope.$index,scope.row,'ico1.abi_ex2')"></el-input>
								</template>
							</el-table-column>
						</el-table-column>
				...
				<div>
					...
					<el-table :data="income2" border :row-class-name="rowClassName" @selection-change="handleIncome2" empty-text='空' class="my-table">
						<el-table-column label="经营性收入（年）" align="center">
							...
							<el-table-column label="金额" prop="abi_ex2" min-width="145" >
								<template slot-scope="scope">
									<el-input v-model="income2[scope.row.xh-1].abi_ex2" @change="changeAmt(scope.$index,scope.row,'ico2.abi_ex2')" ></el-input>
								</template>
							</el-table-column>
						</el-table-column>
					</el-table>
				...
				<div>
					...
					<el-table :data="income3" border :row-class-name="rowClassName" @selection-change="handleIncome3" empty-text='空' class="my-table">
						<el-table-column label="财产性收入（年）" align="center">
							...
							<el-table-column label="金额" prop="abi_ex2" min-width="145" >
								<template slot-scope="scope">
									<el-input v-model="income3[scope.row.xh-1].abi_ex2" @change="changeAmt(scope.$index,scope.row,'ico3.abi_ex2')"></el-input>
								</template>
							</el-table-column>
						</el-table-column>
				...
				<div>
					...
					<el-table :data="income4" border :row-class-name="rowClassName" @selection-change="handleIncome4" empty-text='空' class="my-table">
						<el-table-column label="转移净收入（年）" align="center">
							...
							<el-table-column label="金额" prop="abi_ex2" min-width="145" >
								<template slot-scope="scope">
									<el-input v-model="income4[scope.row.xh-1].abi_ex2" @change="changeAmt(scope.$index,scope.row,'ico4.abi_ex2')"></el-input>
								</template>
							</el-table-column>
						</el-table-column>
					</el-table>
				...
				<div>
					<el-table :data="income5" border :row-class-name="rowClassName" @selection-change="handleFamilyData3" empty-text='空' class="my-table">
						<el-table-column label="其他收入（年）" align="center">
							<el-table-column label="计入收入名称" prop="abi_ex1" min-width="140">
								<template >
									<el-input :value="income5[0].abi_ex1"></el-input>
								</template>
							</el-table-column>
							<el-table-column label="金额" prop="abi_ex2" min-width="145" >
								<template slot-scope="scope">
									<el-input v-model="income5[scope.row.xh-1].abi_ex2" @change="changeAmt(scope.$index,scope.row,'ico5.abi_ex2')"></el-input>
								</template>
							</el-table-column>
						</el-table-column>
					</el-table>
				...
				<div>
					<el-table :data="income6" border :row-class-name="rowClassName" @selection-change="handleFamilyData3" empty-text='空' class="my-table">
						<el-table-column label="必要就业成本抵扣" align="center">
							<el-table-column label="计入收入名称" prop="abi_ex1" min-width="140">
								<template>
									<el-input :value="income6[0].abi_ex1"></el-input>
								</template>
							</el-table-column>
							<el-table-column label="金额" prop="abi_ex2" min-width="145" >
								<template slot-scope="scope">
									<el-input v-model="income6[scope.row.xh-1].abi_ex2" @change="changeAmt(scope.$index,scope.row,'ico6.abi_ex2')"></el-input>
								</template>
							</el-table-column>
						</el-table-column>
				...
				<div>
					<el-table :data="income7" border :row-class-name="rowClassName" empty-text='空' class="my-table">
						<el-table-column label="总收入" align="center">
							<el-table-column label="计入收入名称" prop="abi_ex1" min-width="140">
								<template slot-scope="scope">
									<el-input v-model="income7[scope.row.xh-1].abi_ex1"></el-input>
								</template>
							</el-table-column>
							<el-table-column label="金额" prop="abi_ex2" min-width="145" >
								<template slot-scope="scope">
									<el-input v-model="income7[scope.row.xh-1].abi_ex2" @change="changeAmt(scope.$index,scope.row,'ico7.abi_ex2')"></el-input>
								</template>
							</el-table-column>
				...
				<el-row :gutter="20">
					<el-col :span="12" >
						<el-form-item label="医疗支出" prop="abp_ex4" label-width="200px">
							<el-input v-model="pay.abp_ex4" placeholder="请输入医疗支出" @change="changeAmt(scope.$index,scope.row,'pay.abp_ex4')"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="教育支出" prop="ab6_ex5" label-width="200px">
							<el-input v-model="pay.abp_ex5" placeholder="请输入教育支出" @change="changeAmt(scope.$index,scope.row,'pay.abp_ex5')">
							</el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="残疾康复费用支出" prop="abp_ex6" label-width="200px">
							<el-input v-model="pay.abp_ex6" placeholder="请输入残疾康复费用支出" @change="changeAmt(scope.$index,scope.row,'pay.abp_ex6')"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="因灾、因意外事故费用支出" prop="abp_ex11" label-width="200px">
							<el-input v-model="pay.abp_ex11" placeholder="请输入因灾、因意外事故费用支出" @change="changeAmt(scope.$index,scope.row,'pay.abp_ex11')"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="其他支出" prop="abp_ex7"  label-width="200px">
							<el-input v-model="pay.abp_ex7" placeholder="请输入其他支出" @change="changeAmt(scope.$index,scope.row,'pay.abp_ex7')"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="家庭总支出" prop="abp_ex8" label-width="200px">
							<el-input v-model="pay.abp_ex8" placeholder="请输入家庭总支出" @change="changeAmt(scope.$index,scope.row,'pay.abp_ex8')"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="扣减刚性支出后家庭年收入" prop="abp_ex9" label-width="200px">
							<el-input v-model="pay.abp_ex9" placeholder="请输入扣减刚性支出后家庭年收入" @change="changeAmt(scope.$index,scope.row,'pay.abp_ex9')">
							</el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="扣减刚性支出后人均年收入" prop="abp_ex10" label-width="200px">
							<el-input v-model="pay.abp_ex10" placeholder="扣减刚性支出后人均年收入"  @change="changeAmt(scope.$index,scope.row,'pay.abp_ex10')"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
...
<script>
	...
	export default {
		...
		data() {
			...
			jisuanShow:false,
			kxsjz:["儿童救助","临时救助","特困人员供养","支出性贫困家庭","低收入家庭","低保边缘家庭","最低生活保障-按人保","最低生活保障-按户保","重病-单人保","重残-单人保"],
			jsjg:[],
			jsjgString:"",
			jsjgshow1:false,
			jsjgshow2:true,
		...
		methods: {
			keyVerification2(index,row,id){
				...
				console.log(index,row.abm_ex3,id);
			},
			...
			isNum(key,id){
				...
				if(!reg7.test(key)&&id=="f1.abm_ex17"){
					this.$message.warning("月收入只能填报数字");
					return false;
				}
				if(!reg7.test(key)&&id=="f2.abm_ex17"){
					this.$message.warning("非共同生活赡抚养人，月人均收入只能填报数字");
					return false;
				}
				if(!reg7.test(key)&&id=="f2.abm_ex18"){
					this.$message.warning("非共同生活赡抚养人，月赡(扶、抚)养费只能填报数字");
					return false;
				}
			},
			// 内容验证
			...
			changeJS(){
				...
				if( this.jisuan.familyAmt/12<740){
					if(this.jisuan.familyNum==1 && this.familyData2.length<1) {
						jsjg.push(this.kxsjz[2]) ; //家庭人口=1，没有赡抚养人(不管有没有重残重病)---特困
						console.log(jsjg,"特困");
					}else if( this.jisuan.familyNum>1||this.familyData2.length>=1) {
						jsjg.push(this.kxsjz[7]); //有赡抚养人(非共同生活>=1)或共同生活>1(有或没有重残重病)---按户保
						console.log(jsjg,"按户保");
			...
			loadData() {// 进入页面加载数据
				...
				// 成员信息
					this.loadFamily({
						...
						// 	this.income7[2].abi_ex2 = Number (this.income7[0].abi_ex2/12); 
						// 	this.pay.abp_ex10=Number(this.pay.abp_ex9)
						// }else{
						// 	this.income7[2].abi_ex2 = Number (this.income7[0].abi_ex2/12/this.familyData1.length).toFixed(2);
					...
					this.getBasicIncome({
						...
						if(income7.length>0){
							for(let i in income7 ){
								this.income7[i]=income7[i];
							}
			...
			changeAmt(total) {
				...
				if(this.familyData1.length>0){
					...
					this.income7[2].abi_ex2=amt/12/this.familyData1.length; //月人均
					...
					this.income7[2].abi_ex2=amt/12/1;
					this.jisuan.familyZB=illness;  //重病
					this.jisuan.familyZC=disability;	//重残
