<template>
	<div class="g-box">
		<div class="g-box2">
			<div class="info2">
				<el-form :model="dibaoForm"  :rules="rulesForm" v-if="isOk" :inline-message="true" :show-message="false" ref="dibaoForm" label-width="auto" style='padding-right: 10px;' @submit.native.prevent>
					...
					<el-row :gutter="20">
						...
						<el-col :span="12">
							<el-form-item label="姓名" prop="name">
								<el-input  v-model="dibaoForm.name" placeholder="请输入儿童姓名"></el-input>
							</el-form-item>
						</el-col>
                    ...
                    <el-row :gutter="20"  v-if="this.dibaoForm.abc_ex205=='委托确认'">
                    	...
                    	<el-col :span="12">
                    		<el-form-item label="调查时间" prop="abc_dat11">
                    			<el-date-picker v-model="dibaoForm.abc_dat11" type="date" value-format="YYYY-mm-dd HH:MM:SS HH:MM:SS" placeholder="选择调查时间" style="width: 100% !important;"></el-date-picker>
                    		</el-form-item>
                    	</el-col>
                    </el-row>
	...
	export default {
		...
		methods: {
			...
			async save() {
				...
				const res = await this.$refs('dibaoForm').validate();
				console.log(res)
				// (valid,obj) => {
				// 	console.log(valid)
				// 	if (valid) {
