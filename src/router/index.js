...
const mainRoutes = {
  ...
  children: [
    ...
    },
    {
      ...
      path: '/tbjmcz',
      name: 'tbjmcz',
      component: _import('modules/assistance/tbjm/tbjmcz'),
      meta: {
        title: '同步省厅操作',
      },
      children: [],
    ...
    },
    {
      ...
      name: 'dbEarlyWarming',
      component: _import(
        'modules/assistance/earlyWarningInfo/dbEarlyWarming/index'
      ),
      meta: {
        title: '城乡低保预警',
      },
...

    {
      ...
      component: _import(
        'modules/assistance/earlyWarningInfo/difficultyEarlyWarning/index'
      ),
      meta: {
        title: '特困供养预警',
      },
    ...
    },
    {
      ...
      component: _import(
        'modules/assistance/earlyWarningInfo/lowIncomeEarlyWarning/index'
      ),
      meta: {
        title: '低收入家庭预警',
      },
    ...
    },
    {
      ...
      component: _import(
        'modules/assistance/earlyWarningInfo/salvationEarlyWarning/index'
      ),
      meta: {
        title: '临时救助预警',
      },
...

    {
      ...
      component: _import(
        'modules/assistance/earlyWarningInfo/childEarlyWarning/index'
      ),
      meta: {
        title: '困境儿童预警',
      },
...

    {
      ...
      component: _import(
        'modules/assistance/earlyWarningInfo/handicappedEarlyWarning/index'
      ),
      meta: {
        title: '残疾人预警',
      },
    ...
    // {
    // 	path: '/kjetListChange',
    // 	component: _import('modules/assistance/kjet/kjetListChange'),
    // 	name: 'kjetListChange',
    // 	meta: {
    // 		title: '困境儿童变更'
    // 	},
    ...
    // },{
    // 	path: '/kjetListCancel',
    // 	component: _import('modules/assistance/kjet/kjetListCancel'),
    // 	name: 'kjetListCancel',
    // 	meta: {
    // 		title: '困境儿童注销'
    // 	},
    ...
    },
    {
      ...
      component: _import(
        'modules/assistance/SubsidyDisabled/toViewThePage/index'
      ),
      name: 'toViewThePage',
      meta: {
        title: '残疾人补贴审核查看页面',
    ...
    },
    {
      ...
      component: _import(
        'modules/assistance/SubsidyDisabled/toChangeThePage/index'
      ),
    ...
    },
    {
      ...
      component: _import(
        'modules/assistance/SubsidyDisabled/subsidyCancell/index'
      ),
      name: 'subsidyCancell',
      meta: {
        title: '残疾人补贴注销',
    ...
    },
    {
      ...
      component: _import(
        'modules/assistance/SubsidyDisabled/giveAllowance/index'
      ),
      name: 'giveAllowance',
      meta: {
        title: '残疾人补贴发放',
    ...
    },
    {
      ...
      component: _import(
        'modules/assistance/zcyj/disabledDbw/disabledDbwReuse'
      ),
    ...
    },
    {
      ...
      component: _import(
        'modules/assistance/zcyj/disabledDbn/disabledDbnReuse'
      ),
    ...
    },
    {
      ...
      component: _import(
        'modules/assistance/zcyj/disabledDbn/disabledDbnzlReuse'
      ),
    ...
    },
    {
      ...
      component: _import(
        'modules/assistance/zcyj/disabledDsr/disabledDsrReuse'
      ),
    ...
    },
    {
      ...
      component: _import('modules/assistance/qzsq/qzsqListView'),
      // component: _import('modules/assistancezdjcyjk/jyyjListView'),
      meta: {
        title: '教育预警查看',
      },
      children: [],
    ...
    // 	path: '/gxhyj',
    // 	name: 'gxhyj',
    // 	component: _import('modules/assistance/gxhyj/gxhyj'),
    // 	meta: {
    // 		title: '个性化预警'
    // 	},
    // 	children: []
    ...
    {
      path: '/test',
      component: _import('modules/assistance/test'),
      name: 'test',
      meta: {
        title: '测试2',
      },
  ...
  if (
    ...
    if (token) {
      defaultMainTemp = mainRoutes.children.filter((item) => {
        item.path.indexOf(generalConfig.defaultUrl) < 0
          ? (item.path =
              generalConfig.defaultUrl + '/' + item.path.replace(/^\//, ''))
          : item.path
        item.name.indexOf(generalConfig.defaultUrl) < 0
          ? (item.name =
              generalConfig.defaultUrl + '/#/' + item.path.replace(/^\//, ''))
          : item.path
        return item
...
function fnAddDynamicMenuRoutes(menuList = [], routes = []) {
  ...
  for (var i = 0; i < menuList.length; i++) {
    if (menuList[i].children && menuList[i].children.length >= 1) {
      ...
      menuList[i].requestAction &&
      /\S/.test(menuList[i].requestAction)
    ) {
      ...
      var route = {
        path:
          menuList[i].context +
          '/' +
          menuList[i].requestAction.replace('/', '/'),
      ...
      if (isURL(menuList[i].requestAction)) {
        ...
        route['meta']['iframeUrl'] =
          menuList[i].context + '/' + menuList[i].requestAction
      } else {
        try {
          route['component'] =
            _import(`modules/${menuList[i].requestAction}`) || null
        } catch (e) {}
      }
